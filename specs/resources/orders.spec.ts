...
import { addresses, adyen_payments, type CommerceLayerClient, customers, markets, type Order, orders, payment_methods, stores, tags } from '../../src'
...
describe('Orders resource', () => {
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '._refresh_prices', async () => {
	  ...
	  const id = TestData.id
		...
		await orders._refresh_prices(id, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
