...
import { CommerceLayerClient, PriceVolumeTier, price_volume_tiers, prices } from '../../lib'
...
describe('PriceVolumeTiers resource', () => {

  const resourceType = 'price_volume_tiers'
  const resourcePath = 'price_volume_tiers'
  ...
  */
  ...
  /* spec.instance start */
    ...
    expect(price_volume_tiers)
		expect(price_volume_tiers.type()).toBe(resourceType)
	})
	/* spec.instance stop */
