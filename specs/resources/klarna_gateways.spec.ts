...
import { type CommerceLayerClient, type KlarnaGateway, klarna_gateways, klarna_payments } from '../../src/single-client'
...
describe('KlarnaGateways resource', () => {
  ...
  */
  ...
  test(resourceType + '.klarna_payments', async () => {
    ...
    await klarna_gateways
      .klarna_payments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
