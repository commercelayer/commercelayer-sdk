...
describe('ParcelLineItems resource', () => {

  const resourceType = 'parcel_line_items'
  ...
  it(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourceType].isParcelLineItem(data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isParcelLineItem(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourceType].parse(payload) as ParcelLineItem
  ...
  /* spec.parse.stop */
	...
	it(resourceType + '.parcel', async () => {
		...
		const intId = cl.addRequestInterceptor((request) => {
			expect(request.options.method).toBe('GET')
			checkCommon(request, resourceType, id, currentAccessToken, 'parcel')
			checkCommonParams(request, params)
			return interceptRequest()
		})
	...
	it(resourceType + '.stock_line_item', async () => {
		...
		const intId = cl.addRequestInterceptor((request) => {
			expect(request.options.method).toBe('GET')
			checkCommon(request, resourceType, id, currentAccessToken, 'stock_line_item')
			checkCommonParams(request, params)
			return interceptRequest()
		})
