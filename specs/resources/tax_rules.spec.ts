...
import { type CommerceLayerClient, manual_tax_calculators, type TaxRule, tax_rules } from '../../src/single-client'
...
describe('TaxRules resource', () => {
  ...
  */
  ...
  test(resourceType + '.manual_tax_calculator', async () => {
    ...
    await tax_rules
      .manual_tax_calculator(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
