...
import { type CommerceLayerSingleClient, type PaypalGateway, paypal_gateways } from '../../src/single-client'
...
describe('PaypalGateways resource', () => {
  ...
  */
  ...
  test(resourceType + '.paypal_payments', async () => {
    ...
    await paypal_gateways
      .paypal_payments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
