...
import { CommerceLayerClient, CustomerAddress, customer_addresses } from '../../src'
...
describe('CustomerAddresses resource', () => {
  ...
  test(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourcePath].isCustomerAddress(data.data)).toBeTruthy()
  ...
  test(resourceType + '.type', async () => {
    ...
    expect(cl[resourcePath].isCustomerAddress(resource)).toBeTruthy()
  ...
  test(resourceType + '.parse', async () => {
    ...
    const res = cl[resourcePath].parse(payload) as CustomerAddress
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.address', async () => {
		...
		await cl[resourcePath].address(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
