...
describe('StripeGateways resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const params = { fields: { stripe_gateways: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isStripeGateway(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isStripeGateway(resource)).toBeTruthy()
  ...
  /* spec.type.stop */
	...
	it(resourceType + '.stripe_payments', async () => {
		...
		const intId = cl.addRequestInterceptor((config) => {
			expect(config.method).toBe('get')
			checkCommon(config, resourceType, id, currentAccessToken, 'stripe_payments')
			checkCommonParams(config, params)
			return interceptRequest()
		})
