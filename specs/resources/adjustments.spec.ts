...
describe('Adjustments resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const createAttributes = { name: 'gamma', currency_code: 'alfa', amount_cents: 10 }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isAdjustment(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.retrieve', async () => {
    ...
    const params = { fields: { adjustments: CommonData.paramsFields } }
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isAdjustment(resource)).toBeTruthy()
