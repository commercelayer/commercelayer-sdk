...
import { type CommerceLayerClient, type CustomerPasswordReset, customer_password_resets } from '../../src/single-client'
...
describe('CustomerPasswordResets resource', () => {
  ...
  test(resourceType + '.create', async () => {
    ...
    await customer_password_resets
  ...
  */
  ...
  test(resourceType + '._reset_password_token', async () => {
    ...
    await customer_password_resets
      ._reset_password_token(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
