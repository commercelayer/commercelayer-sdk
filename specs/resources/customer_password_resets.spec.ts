...
describe('CustomerPasswordResets resource', () => {

  const resourceType = 'customer_password_resets'
  ...
  it(resourceType + '.create', async () => {
    ...
    const createAttributes = {
			customer_email: 'epsilon_57',
		}

    const attributes = { ...createAttributes, reference: TestData.reference }
    const params = { fields: { customer_password_resets: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isCustomerPasswordReset(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isCustomerPasswordReset(resource)).toBeTruthy()
