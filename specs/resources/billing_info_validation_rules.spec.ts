...
describe('BillingInfoValidationRules resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const params = { fields: { billing_info_validation_rules: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isBillingInfoValidationRule(config.data.data)).toBeTruthy()
