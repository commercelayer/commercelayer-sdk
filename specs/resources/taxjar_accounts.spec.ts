...
describe('TaxjarAccounts resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourceType].isTaxjarAccount(data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isTaxjarAccount(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourceType].parse(payload) as TaxjarAccount
  ...
  */
  /* spec.parse.stop */
	...
	it(resourceType + '.tax_categories', async () => {
		...
		const intId = cl.addRequestInterceptor((request) => {
			expect(request.options.method).toBe('GET')
			checkCommon(request, resourceType, id, currentAccessToken, 'tax_categories')
			checkCommonParams(request, params)
			return interceptRequest()
		})
