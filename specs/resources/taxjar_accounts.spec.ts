...
import { type CommerceLayerClient, type TaxjarAccount, tax_categories, taxjar_accounts } from '../../src/single-client'
...
describe('TaxjarAccounts resource', () => {
  ...
  */
  ...
  test(resourceType + '.tax_categories', async () => {
    ...
    await taxjar_accounts
      .tax_categories(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
