...
import { type AdyenGateway, adyen_gateways, adyen_payments, type CommerceLayerClient } from '../../src/single-client'
...
describe('AdyenGateways resource', () => {
  ...
  */
  ...
  test(resourceType + '.adyen_payments', async () => {
    ...
    await adyen_gateways
      .adyen_payments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
