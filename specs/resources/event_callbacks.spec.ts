...
import { type CommerceLayerSingleClient, type EventCallback, event_callbacks } from '../../src/single-client'
...
describe('EventCallbacks resource', () => {
  ...
  */
  ...
  test(resourceType + '.webhook', async () => {
    ...
    await event_callbacks
      .webhook(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
