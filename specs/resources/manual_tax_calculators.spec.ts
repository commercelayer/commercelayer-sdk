...
import { CommerceLayerClient, ManualTaxCalculator } from '../../src'
...
describe('ManualTaxCalculators resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isManualTaxCalculator(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isManualTaxCalculator(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourceType].parse(payload) as ManualTaxCalculator
  ...
  /* spec.parse.stop */
	...
	it(resourceType + '.tax_rules', async () => {
		...
		const intId = cl.addRequestInterceptor((config) => {
			expect(config.method).toBe('get')
			checkCommon(config, resourceType, id, currentAccessToken, 'tax_rules')
			checkCommonParams(config, params)
			return interceptRequest()
		})
