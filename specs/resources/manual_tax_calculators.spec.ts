...
import { type CommerceLayerClient, type ManualTaxCalculator, manual_tax_calculators, tax_rules } from '../../src'
...
describe('ManualTaxCalculators resource', () => {
  ...
  */
  ...
  test(resourceType + '.tax_rules', async () => {
    ...
    await manual_tax_calculators
      .tax_rules(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
