...
import { type CheckoutComGateway, type CommerceLayerClient, checkout_com_gateways, checkout_com_payments } from '../../src'
  ...
  /* spec.instance start */
	...
	test(resourceType + '._update_webhooks', async () => {
	  ...
	  const id = TestData.id
		...
		await checkout_com_gateways._update_webhooks(id, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
