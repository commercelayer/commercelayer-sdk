...
import { CommerceLayerClient, VertexAccount, vertex_accounts } from '../../lib'
...
describe('VertexAccounts resource', () => {

  const resourceType = 'vertex_accounts'
  const resourcePath = 'vertex_accounts'
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.event_stores', async () => {
		...
		await vertex_accounts.event_stores(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
