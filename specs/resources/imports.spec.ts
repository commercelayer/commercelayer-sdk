...
import { CommerceLayerClient, Import, imports } from '../../lib'
...
describe('Imports resource', () => {
  ...
  */
  ...
  /* spec.instance start */
    ...
    expect(imports)
		expect(imports.type()).toBe(resourceType)
	})
	/* spec.instance stop */
	...
	test(resourceType + '.event_stores', async () => {
		...
		await imports.event_stores(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
