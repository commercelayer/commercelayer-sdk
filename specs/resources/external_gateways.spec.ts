...
describe('ExternalGateways resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const params = { fields: { external_gateways: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isExternalGateway(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isExternalGateway(resource)).toBeTruthy()
  ...
  /* spec.type.stop */
	...
	it(resourceType + '.external_payments', async () => {
		...
		const intId = cl.addRequestInterceptor((config) => {
			expect(config.method).toBe('get')
			checkCommon(config, resourceType, id, currentAccessToken, 'external_payments')
			checkCommonParams(config, params)
			return interceptRequest()
		})
