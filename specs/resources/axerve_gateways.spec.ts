...
import { type AxerveGateway, axerve_gateways, axerve_payments, type CommerceLayerClient } from '../../src/single-client'
...
describe('AxerveGateways resource', () => {
  ...
  */
  ...
  test(resourceType + '.axerve_payments', async () => {
    ...
    await axerve_gateways
      .axerve_payments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
