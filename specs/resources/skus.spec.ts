...
import { type CommerceLayerSingleClient, type Sku, shipping_categories, skus, tags } from '../../src/single-client'
...
describe('Skus resource', () => {
  ...
  */
  ...
  test(resourceType + '.prices', async () => {
    ...
    await skus
      .prices(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_items', async () => {
    ...
    await skus
      .stock_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.delivery_lead_times', async () => {
    ...
    await skus
      .delivery_lead_times(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.sku_options', async () => {
    ...
    await skus
      .sku_options(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.sku_list_items', async () => {
    ...
    await skus
      .sku_list_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
