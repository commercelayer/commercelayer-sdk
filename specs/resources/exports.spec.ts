...
import { CommerceLayerClient, Export, exportz } from '../../src'
...
describe('Exports resource', () => {
  ...
  test(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourcePath].isExport(data.data)).toBeTruthy()
  ...
  test(resourceType + '.type', async () => {
    ...
    expect(cl[resourcePath].isExport(resource)).toBeTruthy()
  ...
  test(resourceType + '.parse', async () => {
    ...
    const res = cl[resourcePath].parse(payload) as Export
  ...
  */
  ...
  /* spec.instance start */
    ...
    expect(exportz)
		expect(exportz.type()).toBe(resourceType)
	})
	/* spec.instance stop */
