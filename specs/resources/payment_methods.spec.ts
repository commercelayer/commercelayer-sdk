...
import { CommerceLayerClient, PaymentMethod, payment_methods, markets, payment_gateways, stores } from '../../lib'
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.event_stores', async () => {
		...
		await payment_methods.event_stores(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
