...
import { type Authorization, authorizations, type CommerceLayerSingleClient } from '../../src/single-client'
...
describe('Authorizations resource', () => {
  ...
  */
  ...
  test(resourceType + '._forward', async () => {
    ...
    await authorizations
      ._forward(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._capture_amount_cents', async () => {
    ...
    await authorizations
      ._capture_amount_cents(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
