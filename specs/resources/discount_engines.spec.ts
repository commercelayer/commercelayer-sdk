...
import { CommerceLayerClient, DiscountEngine } from '../../src'
...
describe('DiscountEngines resource', () => {
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourcePath].isDiscountEngine(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourcePath].parse(payload) as DiscountEngine
  ...
  */
  /* spec.parse.stop */
	...
	it(resourceType + '.discount_engine_items', async () => {
