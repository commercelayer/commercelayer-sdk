...
import { CommerceLayerClient, DeliveryLeadTime } from '../../src'
...
describe('DeliveryLeadTimes resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isDeliveryLeadTime(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isDeliveryLeadTime(resource)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourceType].parse(payload) as DeliveryLeadTime
