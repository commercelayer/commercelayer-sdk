...
import { type CommerceLayerClient, type GiftCard, gift_card_recipients, gift_cards, markets, tags } from '../../src'
...
describe('GiftCards resource', () => {
  ...
  */
  ...
  test(resourceType + '.gift_card_recipient', async () => {
    ...
    await gift_cards
      .gift_card_recipient(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._balance_change_cents', async () => {
    ...
    await gift_cards
      ._balance_change_cents(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
