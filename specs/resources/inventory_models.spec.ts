...
import { type CommerceLayerSingleClient, type InventoryModel, inventory_models } from '../../src/single-client'
...
describe('InventoryModels resource', () => {
  ...
  */
  ...
  test(resourceType + '.inventory_stock_locations', async () => {
    ...
    await inventory_models
      .inventory_stock_locations(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.inventory_return_locations', async () => {
    ...
    await inventory_models
      .inventory_return_locations(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
