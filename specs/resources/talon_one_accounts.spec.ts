...
import { type CommerceLayerSingleClient, type TalonOneAccount, talon_one_accounts } from '../../src/single-client'
...
describe('TalonOneAccounts resource', () => {
  ...
  */
  ...
  test(resourceType + '.discount_engine_items', async () => {
    ...
    await talon_one_accounts
      .discount_engine_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
