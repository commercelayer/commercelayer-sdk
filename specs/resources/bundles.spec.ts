...
import { type Bundle, bundles, type CommerceLayerSingleClient, markets, sku_lists, tags } from '../../src/single-client'
...
describe('Bundles resource', () => {
  ...
  */
  ...
  test(resourceType + '._compute_price_amount', async () => {
    ...
    await bundles
      ._compute_price_amount(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._compute_compare_at_amount', async () => {
    ...
    await bundles
      ._compute_compare_at_amount(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
