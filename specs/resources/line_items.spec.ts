...
import { type CommerceLayerSingleClient, type LineItem, line_items, orders, skus, tags } from '../../src/single-client'
...
describe('LineItems resource', () => {
  ...
  */
  ...
  test(resourceType + '._external_price', async () => {
    ...
    await line_items
      ._external_price(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._reset_restocked_quantity', async () => {
    ...
    await line_items
      ._reset_restocked_quantity(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
