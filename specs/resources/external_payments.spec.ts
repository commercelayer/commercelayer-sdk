...
import { type CommerceLayerClient, type ExternalPayment, external_payments, orders } from '../../src/single-client'
...
describe('ExternalPayments resource', () => {
  ...
  */
  ...
  test(resourceType + '.wallet', async () => {
    ...
    await external_payments
      .wallet(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
