...
import { type CommerceLayerClient, type StockReservation, stock_items, stock_reservations } from '../../src'
...
describe('StockReservations resource', () => {
  ...
  */
  ...
  test(resourceType + '.stock_line_item', async () => {
    ...
    await stock_reservations
      .stock_line_item(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_transfer', async () => {
    ...
    await stock_reservations
      .stock_transfer(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.reserved_stock', async () => {
    ...
    await stock_reservations
      .reserved_stock(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
