...
describe('BuyXPayYPromotions resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const params = { fields: { buy_x_pay_y_promotions: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isBuyXPayYPromotion(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isBuyXPayYPromotion(resource)).toBeTruthy()
