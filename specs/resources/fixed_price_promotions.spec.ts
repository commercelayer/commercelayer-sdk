...
describe('FixedPricePromotions resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const createAttributes = {
			...
			expires_at: 'epsilon_63',
			total_usage_limit: 1,
			fixed_amount_cents: 555,
    ...
    const params = { fields: { fixed_price_promotions: CommonData.paramsFields } }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isFixedPricePromotion(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isFixedPricePromotion(resource)).toBeTruthy()
