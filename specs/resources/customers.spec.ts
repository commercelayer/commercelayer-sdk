...
import { type CommerceLayerClient, type Customer, customer_groups, customers, tags } from '../../src/single-client'
...
describe('Customers resource', () => {
  ...
  */
  ...
  test(resourceType + '.customer_group', async () => {
    ...
    await customers
      .customer_group(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.customer_addresses', async () => {
    ...
    await customers
      .customer_addresses(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.customer_payment_sources', async () => {
    ...
    await customers
      .customer_payment_sources(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.customer_subscriptions', async () => {
    ...
    await customers
      .customer_subscriptions(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.sku_lists', async () => {
    ...
    await customers
      .sku_lists(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.jwt_customer', async () => {
    ...
    await customers
      .jwt_customer(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.jwt_markets', async () => {
    ...
    await customers
      .jwt_markets(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.jwt_stock_locations', async () => {
    ...
    await customers
      .jwt_stock_locations(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._request_anonymization', async () => {
    ...
    await customers
      ._request_anonymization(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._cancel_anonymization', async () => {
    ...
    await customers
      ._cancel_anonymization(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
