...
import { CommerceLayerClient, Coupon, coupons, coupon_codes_promotion_rules, coupon_recipients, tags } from '../../lib'
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.event_stores', async () => {
		...
		await coupons.event_stores(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
