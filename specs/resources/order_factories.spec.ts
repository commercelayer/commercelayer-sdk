...
import { CommerceLayerClient, OrderFactory, order_factories } from '../../lib'
...
describe('OrderFactories resource', () => {

  const resourceType = 'order_factories'
  const resourcePath = 'order_factories'
