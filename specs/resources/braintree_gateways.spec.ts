...
describe('BraintreeGateways resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    const createAttributes = { name: 'epsilon', merchant_account_id: 'epsilon', merchant_id: 'epsilon', public_key: 'gamma', private_key: 'alfa' }
    ...
    const intId = cl.addRequestInterceptor((config) => {
      ...
      expect(cl[resourceType].isBraintreeGateway(config.data.data)).toBeTruthy()
  ...
  it(resourceType + '.type', async () => {
    ...
    expect(cl[resourceType].isBraintreeGateway(resource)).toBeTruthy()
