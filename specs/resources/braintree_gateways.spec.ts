...
import { CommerceLayerClient, BraintreeGateway, braintree_gateways } from '../../src'
...
describe('BraintreeGateways resource', () => {
  ...
  test(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourcePath].isBraintreeGateway(data.data)).toBeTruthy()
  ...
  test(resourceType + '.parse', async () => {
    ...
    const res = cl[resourcePath].parse(payload) as BraintreeGateway
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.braintree_payments', async () => {
		...
		await cl[resourcePath].braintree_payments(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
