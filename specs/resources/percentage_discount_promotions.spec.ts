...
describe('PercentageDiscountPromotions resource', () => {

  const resourceType = 'percentage_discount_promotions'
  const resourcePath = 'percentage_discount_promotions'
  ...
  test(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(percentage_discount_promotions.isPercentageDiscountPromotion(data.data)).toBeTruthy()
      return interceptRequest()
    })

    await percentage_discount_promotions.create(resData, params, CommonData.options)
      .then((res: PercentageDiscountPromotion) =>  expect(res).not.toBeNull())
      .catch(handleError)
  ...
  test(resourceType + '.retrieve', async () => {
    ...
    await percentage_discount_promotions.retrieve(id, params, CommonData.options)
      .then((res: PercentageDiscountPromotion) =>  expect(res).not.toBeNull())
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  ...
  test(resourceType + '.update', async () => {
    ...
    await percentage_discount_promotions.update(resData, params, CommonData.options)
      .then((res: PercentageDiscountPromotion) =>  expect(res).not.toBeNull())
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  ...
  test(resourceType + '.delete', async () => {
    ...
    await percentage_discount_promotions.delete(id, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  ...
  test(resourceType + '.list', async () => {
    ...
    await percentage_discount_promotions.list(params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  ...
  test(resourceType + '.type', async () => {
    ...
    expect(percentage_discount_promotions.isPercentageDiscountPromotion(resource)).toBeTruthy()

    const type = percentage_discount_promotions.type()
  ...
  test(resourceType + '.relationship', async () => {
    ...
    const relId = percentage_discount_promotions.relationship(TestData.id)
    expect(isDeepStrictEqual(relId, { id: TestData.id, type: resourceType}))

    const relResId = percentage_discount_promotions.relationship({ id: TestData.id, type: resourceType })
  ...
  test(resourceType + '.parse', async () => {
    ...
    const res = percentage_discount_promotions.parse(payload) as PercentageDiscountPromotion
  ...
  */
  ...
  /* spec.instance start */
	...
	test(resourceType + '.market', async () => {
		...
		await percentage_discount_promotions.market(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.order_amount_promotion_rule', async () => {
		...
		await percentage_discount_promotions.order_amount_promotion_rule(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.sku_list_promotion_rule', async () => {
		...
		await percentage_discount_promotions.sku_list_promotion_rule(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.coupon_codes_promotion_rule', async () => {
		...
		await percentage_discount_promotions.coupon_codes_promotion_rule(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.custom_promotion_rule', async () => {
		...
		await percentage_discount_promotions.custom_promotion_rule(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.sku_list', async () => {
		...
		await percentage_discount_promotions.sku_list(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.coupons', async () => {
		...
		await percentage_discount_promotions.coupons(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.attachments', async () => {
		...
		await percentage_discount_promotions.attachments(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.events', async () => {
		...
		await percentage_discount_promotions.events(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.tags', async () => {
		...
		await percentage_discount_promotions.tags(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.versions', async () => {
		...
		await percentage_discount_promotions.versions(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.event_stores', async () => {
		...
		await percentage_discount_promotions.event_stores(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '.skus', async () => {
		...
		await percentage_discount_promotions.skus(id, params, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '._disable', async () => {
	  ...
	  const id = TestData.id
		...
		await percentage_discount_promotions._disable(id, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '._enable', async () => {
	  ...
	  const id = TestData.id
		...
		await percentage_discount_promotions._enable(id, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '._add_tags', async () => {
	  ...
	  const id = TestData.id
		...
		await percentage_discount_promotions._add_tags(id, triggerValue, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
	...
	test(resourceType + '._remove_tags', async () => {
	  ...
	  const id = TestData.id
		...
		await percentage_discount_promotions._remove_tags(id, triggerValue, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
