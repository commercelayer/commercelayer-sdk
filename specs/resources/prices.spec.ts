...
import { type CommerceLayerClient, type Price, price_lists, price_tiers, prices, skus } from '../../src/single-client'
...
describe('Prices resource', () => {
  ...
  */
  ...
  test(resourceType + '.price_tiers', async () => {
    ...
    await prices
      .price_tiers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.price_volume_tiers', async () => {
    ...
    await prices
      .price_volume_tiers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.price_frequency_tiers', async () => {
    ...
    await prices
      .price_frequency_tiers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
