...
import { type CommerceLayerClient, coupon_codes_promotion_rules, custom_promotion_rules, type ExternalPromotion, external_promotions, markets, order_amount_promotion_rules, sku_list_promotion_rules, sku_lists, tags } from '../../src'
  ...
  /* spec.instance start */
	...
	test(resourceType + '._regenerate_shared_secret', async () => {
	  ...
	  const id = TestData.id
		...
		await external_promotions._regenerate_shared_secret(id, {}, CommonData.options)
			.catch(handleError)
			.finally(() => cl.removeInterceptor('request'))
