...
import { CommerceLayerClient, KlarnaPayment } from '../../src'
...
describe('KlarnaPayments resource', () => {
  ...
  it(resourceType + '.create', async () => {
    ...
    cl.addRequestInterceptor((request) => {
      ...
      expect(cl[resourceType].isKlarnaPayment(data.data)).toBeTruthy()
  ...
  it(resourceType + '.parse', async () => {
    ...
    const res = cl[resourceType].parse(payload) as KlarnaPayment
