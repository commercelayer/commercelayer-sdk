...
export type ReturnLineItemSort = Pick<ReturnLineItem, 'id' | 'quantity' | 'total_amount_cents' | 'restocked_at'> &
  ResourceSort
...
class ReturnLineItems extends ApiResource<ReturnLineItem> {
  ...
  async create(
    resource: ReturnLineItemCreate,
    params?: QueryParamsRetrieve<ReturnLineItem>,
    options?: ResourcesConfig,
  ): Promise<ReturnLineItem> {
    return this.resources.create<ReturnLineItemCreate, ReturnLineItem>(
      { ...resource, type: ReturnLineItems.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: ReturnLineItemUpdate,
    params?: QueryParamsRetrieve<ReturnLineItem>,
    options?: ResourcesConfig,
  ): Promise<ReturnLineItem> {
    return this.resources.update<ReturnLineItemUpdate, ReturnLineItem>(
      { ...resource, type: ReturnLineItems.TYPE },
      params,
      options,
    )
  ...
  async return(
    returnLineItemId: string | ReturnLineItem,
    ...
    return this.resources.fetch<Return>(
      { type: 'returns' },
      `return_line_items/${_returnLineItemId}/return`,
      params,
      options,
  ...
  async line_item(
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `return_line_items/${_returnLineItemId}/line_item`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `return_line_items/${_returnLineItemId}/event_stores`,
      params,
      options,
  ...
  async _restock(
    id: string | ReturnLineItem,
    params?: QueryParamsRetrieve<ReturnLineItem>,
    options?: ResourcesConfig,
  ): Promise<ReturnLineItem> {
    return this.resources.update<ReturnLineItemUpdate, ReturnLineItem>(
      { id: typeof id === 'string' ? id : id.id, type: ReturnLineItems.TYPE, _restock: true },
      params,
      options,
    )
  }
