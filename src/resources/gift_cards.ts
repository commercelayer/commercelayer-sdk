...
export type GiftCardSort = Pick<
  GiftCard,
  'id' | 'status' | 'currency_code' | 'balance_cents' | 'balance_max_cents' | 'expires_at'
> &
  ResourceSort
...
class GiftCards extends ApiResource<GiftCard> {
  ...
  async market(
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `gift_cards/${_giftCardId}/market`,
      params,
      options,
    ) as unknown as Market
  }

  async gift_card_recipient(
    giftCardId: string | GiftCard,
    params?: QueryParamsRetrieve<GiftCardRecipient>,
    options?: ResourcesConfig,
  ): Promise<GiftCardRecipient> {
    const _giftCardId = (giftCardId as GiftCard).id || (giftCardId as string)
    return this.resources.fetch<GiftCardRecipient>(
      { type: 'gift_card_recipients' },
      `gift_cards/${_giftCardId}/gift_card_recipient`,
      params,
      options,
    ) as unknown as GiftCardRecipient
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `gift_cards/${_giftCardId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `gift_cards/${_giftCardId}/event_stores`,
      params,
      options,
  ...
  async _purchase(
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _purchase: true },
      params,
      options,
    )
  }
  ...
  async _activate(
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _activate: true },
      params,
      options,
    )
  }
  ...
  async _deactivate(
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _deactivate: true },
      params,
      options,
    )
  }

  async _balance_change_cents(
    id: string | GiftCard,
    triggerValue: number,
    params?: QueryParamsRetrieve<GiftCard>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _balance_change_cents: triggerValue },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<GiftCardUpdate, GiftCard>(
      { id: typeof id === 'string' ? id : id.id, type: GiftCards.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
