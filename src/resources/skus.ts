...
export type SkuSort = Pick<Sku, 'id' | 'code' | 'do_not_ship' | 'do_not_track' | 'name'> & ResourceSort
// export type SkuFilter = Pick<Sku, 'id' | 'code' | 'description' | 'do_not_ship' | 'do_not_track' | 'image_url' | 'name'> & ResourceFilter
