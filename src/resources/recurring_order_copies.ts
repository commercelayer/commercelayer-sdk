...
export type RecurringOrderCopySort = Pick<
  RecurringOrderCopy,
...
class RecurringOrderCopies extends ApiResource<RecurringOrderCopy> {
  ...
  async create(
    resource: RecurringOrderCopyCreate,
    params?: QueryParamsRetrieve<RecurringOrderCopy>,
    options?: ResourcesConfig,
  ): Promise<RecurringOrderCopy> {
    return this.resources.create<RecurringOrderCopyCreate, RecurringOrderCopy>(
      { ...resource, type: RecurringOrderCopies.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: RecurringOrderCopyUpdate,
    params?: QueryParamsRetrieve<RecurringOrderCopy>,
    options?: ResourcesConfig,
  ): Promise<RecurringOrderCopy> {
    return this.resources.update<RecurringOrderCopyUpdate, RecurringOrderCopy>(
      { ...resource, type: RecurringOrderCopies.TYPE },
      params,
      options,
    )
  ...
  async source_order(
    recurringOrderCopyId: string | RecurringOrderCopy,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `recurring_order_copies/${_recurringOrderCopyId}/source_order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async target_order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `recurring_order_copies/${_recurringOrderCopyId}/target_order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `recurring_order_copies/${_recurringOrderCopyId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `recurring_order_copies/${_recurringOrderCopyId}/event_stores`,
      params,
      options,
  ...
  async order_subscription(
    ...
    return this.resources.fetch<OrderSubscription>(
      ...
      `recurring_order_copies/${_recurringOrderCopyId}/order_subscription`,
      params,
      options,
