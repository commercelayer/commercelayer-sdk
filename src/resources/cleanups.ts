...
class Cleanups extends ApiResource<Cleanup> {
  ...
  async create(
    resource: CleanupCreate,
    params?: QueryParamsRetrieve<Cleanup>,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `cleanups/${_cleanupId}/event_stores`,
      params,
      options,
  ...
  async _interrupt(
    ...
    return this.resources.update<CleanupUpdate, Cleanup>(
      { id: typeof id === 'string' ? id : id.id, type: Cleanups.TYPE, _interrupt: true },
      params,
      options,
    )
  }
...
export type { Cleanup, CleanupCreate, Cleanups, CleanupType, CleanupUpdate }
