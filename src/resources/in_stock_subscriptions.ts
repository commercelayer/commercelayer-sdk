...
class InStockSubscriptions extends ApiResource<InStockSubscription> {
  ...
  async create(
    resource: InStockSubscriptionCreate,
    params?: QueryParamsRetrieve<InStockSubscription>,
    options?: ResourcesConfig,
  ): Promise<InStockSubscription> {
    return this.resources.create<InStockSubscriptionCreate, InStockSubscription>(
      { ...resource, type: InStockSubscriptions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    ...
    return this.resources.update<InStockSubscriptionUpdate, InStockSubscription>(
      { ...resource, type: InStockSubscriptions.TYPE },
      params,
      options,
    )
  ...
  async market(
    inStockSubscriptionId: string | InStockSubscription,
    params?: QueryParamsRetrieve<Market>,
    options?: ResourcesConfig,
  ): Promise<Market> {
    const _inStockSubscriptionId =
      (inStockSubscriptionId as InStockSubscription).id || (inStockSubscriptionId as string)
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `in_stock_subscriptions/${_inStockSubscriptionId}/market`,
      params,
      options,
  ...
  async customer(
    ...
    return this.resources.fetch<Customer>(
      { type: 'customers' },
      `in_stock_subscriptions/${_inStockSubscriptionId}/customer`,
      params,
      options,
  ...
  async sku(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `in_stock_subscriptions/${_inStockSubscriptionId}/sku`,
      params,
      options,
    ) as unknown as Sku
  }
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `in_stock_subscriptions/${_inStockSubscriptionId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `in_stock_subscriptions/${_inStockSubscriptionId}/event_stores`,
      params,
      options,
  ...
  async _activate(
    id: string | InStockSubscription,
    params?: QueryParamsRetrieve<InStockSubscription>,
    options?: ResourcesConfig,
  ): Promise<InStockSubscription> {
    return this.resources.update<InStockSubscriptionUpdate, InStockSubscription>(
      { id: typeof id === 'string' ? id : id.id, type: InStockSubscriptions.TYPE, _activate: true },
      params,
      options,
    )
  }
  ...
  async _deactivate(
    ...
    return this.resources.update<InStockSubscriptionUpdate, InStockSubscription>(
      { id: typeof id === 'string' ? id : id.id, type: InStockSubscriptions.TYPE, _deactivate: true },
      params,
      options,
    )
  }
