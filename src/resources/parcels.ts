...
export type ParcelSort = Pick<
  Parcel,
  'id' | 'weight' | 'tracking_status' | 'tracking_status_updated_at' | 'carrier_weight_oz'
> &
  ResourceSort
...
class Parcels extends ApiResource<Parcel> {
  ...
  async package(
    parcelId: string | Parcel,
    params?: QueryParamsRetrieve<Package>,
    options?: ResourcesConfig,
  ): Promise<Package> {
    const _parcelId = (parcelId as Parcel).id || (parcelId as string)
    return this.resources.fetch<Package>(
      { type: 'packages' },
      `parcels/${_parcelId}/package`,
      params,
      options,
    ) as unknown as Package
  }

  async parcel_line_items(
    parcelId: string | Parcel,
    params?: QueryParamsList<ParcelLineItem>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<ParcelLineItem>> {
    const _parcelId = (parcelId as Parcel).id || (parcelId as string)
    return this.resources.fetch<ParcelLineItem>(
      { type: 'parcel_line_items' },
      `parcels/${_parcelId}/parcel_line_items`,
      params,
      options,
    ) as unknown as ListResponse<ParcelLineItem>
  }
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `parcels/${_parcelId}/event_stores`,
      params,
      options,
...
export type { Parcel, ParcelCreate, Parcels, ParcelType, ParcelUpdate }
