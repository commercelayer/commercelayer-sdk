...
export type PriceSort = Pick<Price, 'id' | 'amount_cents' | 'compare_at_amount_cents' | 'currency_code'> & ResourceSort
// export type PriceFilter = Pick<Price, 'id' | 'amount_cents' | 'compare_at_amount_cents' | 'currency_code' | 'rules'> & ResourceFilter
