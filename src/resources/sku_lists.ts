...
class SkuLists extends ApiResource<SkuList> {
  ...
  async sku_list_items(
    ...
    return this.resources.fetch<SkuListItem>(
      { type: 'sku_list_items' },
      `sku_lists/${_skuListId}/sku_list_items`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `sku_lists/${_skuListId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `sku_lists/${_skuListId}/event_stores`,
      params,
      options,
