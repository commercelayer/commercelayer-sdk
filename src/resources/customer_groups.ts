...
class CustomerGroups extends ApiResource<CustomerGroup> {
  ...
  async create(
    resource: CustomerGroupCreate,
    params?: QueryParamsRetrieve<CustomerGroup>,
    options?: ResourcesConfig,
  ): Promise<CustomerGroup> {
    return this.resources.create<CustomerGroupCreate, CustomerGroup>(
      { ...resource, type: CustomerGroups.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: CustomerGroupUpdate,
    params?: QueryParamsRetrieve<CustomerGroup>,
    options?: ResourcesConfig,
  ): Promise<CustomerGroup> {
    return this.resources.update<CustomerGroupUpdate, CustomerGroup>(
      { ...resource, type: CustomerGroups.TYPE },
      params,
      options,
    )
  ...
  async customers(
    customerGroupId: string | CustomerGroup,
    ...
    return this.resources.fetch<Customer>(
      { type: 'customers' },
      `customer_groups/${_customerGroupId}/customers`,
      params,
      options,
  ...
  async markets(
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `customer_groups/${_customerGroupId}/markets`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `customer_groups/${_customerGroupId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `customer_groups/${_customerGroupId}/event_stores`,
      params,
      options,
