...
export type PriceListSchedulerSort = Pick<
  PriceListScheduler,
  'id' | 'name' | 'starts_at' | 'expires_at' | 'disabled_at'
> &
  ResourceSort
...
class PriceListSchedulers extends ApiResource<PriceListScheduler> {
  ...
  async create(
    resource: PriceListSchedulerCreate,
    params?: QueryParamsRetrieve<PriceListScheduler>,
    options?: ResourcesConfig,
  ): Promise<PriceListScheduler> {
    return this.resources.create<PriceListSchedulerCreate, PriceListScheduler>(
      { ...resource, type: PriceListSchedulers.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: PriceListSchedulerUpdate,
    params?: QueryParamsRetrieve<PriceListScheduler>,
    options?: ResourcesConfig,
  ): Promise<PriceListScheduler> {
    return this.resources.update<PriceListSchedulerUpdate, PriceListScheduler>(
      { ...resource, type: PriceListSchedulers.TYPE },
      params,
      options,
    )
  ...
  async market(
    priceListSchedulerId: string | PriceListScheduler,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `price_list_schedulers/${_priceListSchedulerId}/market`,
      params,
      options,
  ...
  async price_list(
    ...
    return this.resources.fetch<PriceList>(
      { type: 'price_lists' },
      `price_list_schedulers/${_priceListSchedulerId}/price_list`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `price_list_schedulers/${_priceListSchedulerId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `price_list_schedulers/${_priceListSchedulerId}/event_stores`,
      params,
      options,
  ...
  async _disable(
    id: string | PriceListScheduler,
    params?: QueryParamsRetrieve<PriceListScheduler>,
    options?: ResourcesConfig,
  ): Promise<PriceListScheduler> {
    return this.resources.update<PriceListSchedulerUpdate, PriceListScheduler>(
      { id: typeof id === 'string' ? id : id.id, type: PriceListSchedulers.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<PriceListSchedulerUpdate, PriceListScheduler>(
      { id: typeof id === 'string' ? id : id.id, type: PriceListSchedulers.TYPE, _enable: true },
      params,
      options,
    )
  }
