...
export type PriceListSchedulerSort = Pick<PriceListScheduler, 'id' | 'disabled_at' | 'expires_at' | 'name' | 'starts_at'> & ResourceSort
// export type PriceListSchedulerFilter = Pick<PriceListScheduler, 'id' | 'disabled_at' | 'expires_at' | 'name' | 'starts_at'> & ResourceFilter
