...
class ShippingMethods extends ApiResource {
	...
	async list(params?: QueryParamsList, options?: ResourcesConfig): Promise<ShippingMethod[] | DocWithData<ShippingMethod>> {
		return this.resources.list({ type: ShippingMethods.TYPE }, params, options)
	}

	async create(resource: ShippingMethodCreate, options?: ResourcesConfig): Promise<ShippingMethod | DocWithData<ShippingMethod>> {
		return this.resources.create(Object.assign(resource, { type: ShippingMethods.TYPE }) , options)
	}

	async retrieve(id: string, params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<ShippingMethod | DocWithData<ShippingMethod>> {
		return this.resources.retrieve<ShippingMethod>({ type: ShippingMethods.TYPE, id }, params, options)
	}

	async update(resource: ShippingMethodUpdate, options?: ResourcesConfig): Promise<ShippingMethod | DocWithData<ShippingMethod>> {
