...
export type OrderCopySort = Pick<
  OrderCopy,
...
class OrderCopies extends ApiResource<OrderCopy> {
  ...
  async create(
    resource: OrderCopyCreate,
    params?: QueryParamsRetrieve<OrderCopy>,
  ...
  async source_order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `order_copies/${_orderCopyId}/source_order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async target_order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `order_copies/${_orderCopyId}/target_order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `order_copies/${_orderCopyId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `order_copies/${_orderCopyId}/event_stores`,
      params,
      options,
  ...
  async order_subscription(
    ...
    return this.resources.fetch<OrderSubscription>(
      ...
      `order_copies/${_orderCopyId}/order_subscription`,
      params,
      options,
...
export type { OrderCopies, OrderCopy, OrderCopyCreate, OrderCopyType, OrderCopyUpdate }
