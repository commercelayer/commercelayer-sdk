...
class AdyenPayments extends ApiResource<AdyenPayment> {
  ...
  async create(
    resource: AdyenPaymentCreate,
    params?: QueryParamsRetrieve<AdyenPayment>,
    options?: ResourcesConfig,
  ): Promise<AdyenPayment> {
    return this.resources.create<AdyenPaymentCreate, AdyenPayment>(
      { ...resource, type: AdyenPayments.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: AdyenPaymentUpdate,
    params?: QueryParamsRetrieve<AdyenPayment>,
    options?: ResourcesConfig,
  ): Promise<AdyenPayment> {
    return this.resources.update<AdyenPaymentUpdate, AdyenPayment>(
      { ...resource, type: AdyenPayments.TYPE },
      params,
      options,
    )
  ...
  async order(
    adyenPaymentId: string | AdyenPayment,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `adyen_payments/${_adyenPaymentId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async payment_gateway(
    ...
    return this.resources.fetch<PaymentGateway>(
      ...
      `adyen_payments/${_adyenPaymentId}/payment_gateway`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `adyen_payments/${_adyenPaymentId}/event_stores`,
      params,
      options,
  ...
  async _authorize(
    id: string | AdyenPayment,
    params?: QueryParamsRetrieve<AdyenPayment>,
    options?: ResourcesConfig,
  ): Promise<AdyenPayment> {
    return this.resources.update<AdyenPaymentUpdate, AdyenPayment>(
      { id: typeof id === 'string' ? id : id.id, type: AdyenPayments.TYPE, _authorize: true },
      params,
      options,
    )
  }
  ...
  async _details(
    ...
    return this.resources.update<AdyenPaymentUpdate, AdyenPayment>(
      { id: typeof id === 'string' ? id : id.id, type: AdyenPayments.TYPE, _details: true },
      params,
      options,
    )
  }
  ...
  async _balance(
    ...
    return this.resources.update<AdyenPaymentUpdate, AdyenPayment>(
      { id: typeof id === 'string' ? id : id.id, type: AdyenPayments.TYPE, _balance: true },
      params,
      options,
    )
  }
