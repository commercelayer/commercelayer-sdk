...
class LineItems extends ApiResource<LineItem> {
  ...
  async line_item_options(
    ...
    return this.resources.fetch<LineItemOption>(
      ...
      `line_items/${_lineItemId}/line_item_options`,
      params,
      options,
  ...
  async return_line_items(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<ReturnLineItem>> {
    const _lineItemId = (lineItemId as LineItem).id || (lineItemId as string)
    return this.resources.fetch<ReturnLineItem>(
      { type: 'return_line_items' },
      `line_items/${_lineItemId}/return_line_items`,
      params,
      options,
  ...
  async stock_reservations(
    ...
    return this.resources.fetch<StockReservation>(
      ...
      `line_items/${_lineItemId}/stock_reservations`,
      params,
      options,
  ...
  async stock_line_items(
    ...
    return this.resources.fetch<StockLineItem>(
      ...
      `line_items/${_lineItemId}/stock_line_items`,
      params,
      options,
  ...
  async stock_transfers(
    ...
    return this.resources.fetch<StockTransfer>(
      ...
      `line_items/${_lineItemId}/stock_transfers`,
      params,
      options,
  ...
  async notifications(
    ...
    return this.resources.fetch<Notification>(
      { type: 'notifications' },
      `line_items/${_lineItemId}/notifications`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `line_items/${_lineItemId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async _external_price(
    id: string | LineItem,
    params?: QueryParamsRetrieve<LineItem>,
    options?: ResourcesConfig,
  ): Promise<LineItem> {
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _external_price: true },
      params,
      options,
    )
  }
  ...
  async _reserve_stock(
    ...
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _reserve_stock: true },
      params,
      options,
    )
  }

  async _reset_restocked_quantity(
    id: string | LineItem,
    params?: QueryParamsRetrieve<LineItem>,
    options?: ResourcesConfig,
  ): Promise<LineItem> {
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _reset_restocked_quantity: true },
      params,
      options,
    )
  }
  ...
  async _reset_circuit(
    ...
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _reset_circuit: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<LineItemUpdate, LineItem>(
      { id: typeof id === 'string' ? id : id.id, type: LineItems.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
...
export type { LineItem, LineItemCreate, LineItems, LineItemType, LineItemUpdate }
