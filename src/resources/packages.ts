...
export type PackageSort = Pick<Package, 'id' | 'name' | 'code' | 'length' | 'width' | 'height' | 'unit_of_length'> &
  ResourceSort
...
class Packages extends ApiResource<Package> {
  ...
  async stock_location(
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `packages/${_packageId}/stock_location`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `packages/${_packageId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `packages/${_packageId}/event_stores`,
      params,
      options,
