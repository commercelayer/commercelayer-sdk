...
class ExternalGateways extends ApiResource<ExternalGateway> {
	...
	async _regenerate_shared_secret(id: string | ExternalGateway, params?: QueryParamsRetrieve<ExternalGateway>, options?: ResourcesConfig): Promise<ExternalGateway> {
		return this.resources.update<ExternalGatewayUpdate, ExternalGateway>({ id: (typeof id === 'string')? id: id.id, type: ExternalGateways.TYPE, _regenerate_shared_secret: true }, params, options)
	}
