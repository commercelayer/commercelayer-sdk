...
class ManualTaxCalculators extends ApiResource<ManualTaxCalculator> {
  ...
  async create(
    resource: ManualTaxCalculatorCreate,
    params?: QueryParamsRetrieve<ManualTaxCalculator>,
    options?: ResourcesConfig,
  ): Promise<ManualTaxCalculator> {
    return this.resources.create<ManualTaxCalculatorCreate, ManualTaxCalculator>(
      { ...resource, type: ManualTaxCalculators.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: ManualTaxCalculatorUpdate,
    params?: QueryParamsRetrieve<ManualTaxCalculator>,
    options?: ResourcesConfig,
  ): Promise<ManualTaxCalculator> {
    return this.resources.update<ManualTaxCalculatorUpdate, ManualTaxCalculator>(
      { ...resource, type: ManualTaxCalculators.TYPE },
      params,
      options,
    )
  ...
  async markets(
    manualTaxCalculatorId: string | ManualTaxCalculator,
    params?: QueryParamsList<Market>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Market>> {
    const _manualTaxCalculatorId =
      (manualTaxCalculatorId as ManualTaxCalculator).id || (manualTaxCalculatorId as string)
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `manual_tax_calculators/${_manualTaxCalculatorId}/markets`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `manual_tax_calculators/${_manualTaxCalculatorId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `manual_tax_calculators/${_manualTaxCalculatorId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `manual_tax_calculators/${_manualTaxCalculatorId}/event_stores`,
      params,
      options,
  ...
  async tax_rules(
    manualTaxCalculatorId: string | ManualTaxCalculator,
    params?: QueryParamsList<TaxRule>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<TaxRule>> {
    const _manualTaxCalculatorId =
      (manualTaxCalculatorId as ManualTaxCalculator).id || (manualTaxCalculatorId as string)
    return this.resources.fetch<TaxRule>(
      { type: 'tax_rules' },
      `manual_tax_calculators/${_manualTaxCalculatorId}/tax_rules`,
      params,
      options,
    ) as unknown as ListResponse<TaxRule>
  }
