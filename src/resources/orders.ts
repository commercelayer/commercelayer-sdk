...
export type OrderSort = Pick<Order, 'id' | 'adjustment_amount_cents' | 'approved_at' | 'archived_at' | 'cancelled_at' | 'circuit_failure_count' | 'circuit_state' | 'country_code' | 'coupon_code' | 'currency_code' | 'discount_amount_cents' | 'duty_amount_cents' | 'fees_amount_cents' | 'fulfillment_status' | 'fulfillment_updated_at' | 'gift_card_amount_cents' | 'gift_card_code' | 'guest' | 'language_code' | 'number' | 'payment_method_amount_cents' | 'payment_status' | 'payment_updated_at' | 'place_async' | 'placed_at' | 'refreshed_at' | 'shipping_amount_cents' | 'status' | 'subscription_created_at' | 'subtotal_amount_cents' | 'subtotal_tax_amount_cents' | 'tax_included' | 'tax_rate' | 'total_amount_cents' | 'total_tax_amount_cents'> & ResourceSort
// export type OrderFilter = Pick<Order, 'id' | 'adjustment_amount_cents' | 'approved_at' | 'archived_at' | 'cancelled_at' | 'circuit_failure_count' | 'circuit_state' | 'country_code' | 'coupon_code' | 'currency_code' | 'customer_email' | 'discount_amount_cents' | 'duty_amount_cents' | 'fees_amount_cents' | 'fulfillment_status' | 'fulfillment_updated_at' | 'gift_card_amount_cents' | 'gift_card_code' | 'guest' | 'language_code' | 'number' | 'payment_method_amount_cents' | 'payment_status' | 'payment_updated_at' | 'place_async' | 'placed_at' | 'refreshed_at' | 'shipping_amount_cents' | 'status' | 'subscription_created_at' | 'subtotal_amount_cents' | 'subtotal_tax_amount_cents' | 'tax_included' | 'tax_rate' | 'token' | 'total_amount_cents' | 'total_tax_amount_cents'> & ResourceFilter
