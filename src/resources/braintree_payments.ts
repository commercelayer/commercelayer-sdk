...
class BraintreePayments extends ApiResource<BraintreePayment> {
  ...
  async create(
    resource: BraintreePaymentCreate,
    params?: QueryParamsRetrieve<BraintreePayment>,
    options?: ResourcesConfig,
  ): Promise<BraintreePayment> {
    return this.resources.create<BraintreePaymentCreate, BraintreePayment>(
      { ...resource, type: BraintreePayments.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: BraintreePaymentUpdate,
    params?: QueryParamsRetrieve<BraintreePayment>,
    options?: ResourcesConfig,
  ): Promise<BraintreePayment> {
    return this.resources.update<BraintreePaymentUpdate, BraintreePayment>(
      { ...resource, type: BraintreePayments.TYPE },
      params,
      options,
    )
  ...
  async order(
    braintreePaymentId: string | BraintreePayment,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `braintree_payments/${_braintreePaymentId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async payment_gateway(
    ...
    return this.resources.fetch<PaymentGateway>(
      ...
      `braintree_payments/${_braintreePaymentId}/payment_gateway`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `braintree_payments/${_braintreePaymentId}/event_stores`,
      params,
      options,
