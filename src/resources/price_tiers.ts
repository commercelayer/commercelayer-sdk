...
export type PriceTierSort = Pick<PriceTier, 'id' | 'name' | 'price_amount_cents' | 'up_to'> & ResourceSort
// export type PriceTierFilter = Pick<PriceTier, 'id' | 'name' | 'price_amount_cents' | 'up_to'> & ResourceFilter
