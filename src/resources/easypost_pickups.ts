...
export type EasypostPickupSort = Pick<
  EasypostPickup,
  'id' | 'status' | 'min_datetime' | 'max_datetime' | 'purchase_started_at' | 'purchase_completed_at'
> &
  ResourceSort
...
class EasypostPickups extends ApiResource<EasypostPickup> {
  ...
  async create(
    resource: EasypostPickupCreate,
    params?: QueryParamsRetrieve<EasypostPickup>,
    options?: ResourcesConfig,
  ): Promise<EasypostPickup> {
    return this.resources.create<EasypostPickupCreate, EasypostPickup>(
      { ...resource, type: EasypostPickups.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: EasypostPickupUpdate,
    params?: QueryParamsRetrieve<EasypostPickup>,
    options?: ResourcesConfig,
  ): Promise<EasypostPickup> {
    return this.resources.update<EasypostPickupUpdate, EasypostPickup>(
      { ...resource, type: EasypostPickups.TYPE },
      params,
      options,
    )
  ...
  async shipment(
    easypostPickupId: string | EasypostPickup,
    ...
    return this.resources.fetch<Shipment>(
      { type: 'shipments' },
      `easypost_pickups/${_easypostPickupId}/shipment`,
      params,
      options,
  ...
  async parcels(
    ...
    return this.resources.fetch<Parcel>(
      { type: 'parcels' },
      `easypost_pickups/${_easypostPickupId}/parcels`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `easypost_pickups/${_easypostPickupId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `easypost_pickups/${_easypostPickupId}/event_stores`,
      params,
      options,
  ...
  async _purchase(
    id: string | EasypostPickup,
    params?: QueryParamsRetrieve<EasypostPickup>,
    options?: ResourcesConfig,
  ): Promise<EasypostPickup> {
    return this.resources.update<EasypostPickupUpdate, EasypostPickup>(
      { id: typeof id === 'string' ? id : id.id, type: EasypostPickups.TYPE, _purchase: true },
      params,
      options,
    )
  }
