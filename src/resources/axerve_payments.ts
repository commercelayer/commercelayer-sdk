...
class AxervePayments extends ApiResource<AxervePayment> {
  ...
  async create(
    resource: AxervePaymentCreate,
    params?: QueryParamsRetrieve<AxervePayment>,
    options?: ResourcesConfig,
  ): Promise<AxervePayment> {
    return this.resources.create<AxervePaymentCreate, AxervePayment>(
      { ...resource, type: AxervePayments.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: AxervePaymentUpdate,
    params?: QueryParamsRetrieve<AxervePayment>,
    options?: ResourcesConfig,
  ): Promise<AxervePayment> {
    return this.resources.update<AxervePaymentUpdate, AxervePayment>(
      { ...resource, type: AxervePayments.TYPE },
      params,
      options,
    )
  ...
  async order(
    axervePaymentId: string | AxervePayment,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `axerve_payments/${_axervePaymentId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async payment_gateway(
    ...
    return this.resources.fetch<PaymentGateway>(
      ...
      `axerve_payments/${_axervePaymentId}/payment_gateway`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `axerve_payments/${_axervePaymentId}/event_stores`,
      params,
      options,
  ...
  async _update(
    id: string | AxervePayment,
    params?: QueryParamsRetrieve<AxervePayment>,
    options?: ResourcesConfig,
  ): Promise<AxervePayment> {
    return this.resources.update<AxervePaymentUpdate, AxervePayment>(
      { id: typeof id === 'string' ? id : id.id, type: AxervePayments.TYPE, _update: true },
      params,
      options,
    )
  }
...
export type { AxervePayment, AxervePaymentCreate, AxervePayments, AxervePaymentType, AxervePaymentUpdate }
