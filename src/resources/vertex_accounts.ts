...
class VertexAccounts extends ApiResource<VertexAccount> {
  ...
  async create(
    resource: VertexAccountCreate,
    params?: QueryParamsRetrieve<VertexAccount>,
    options?: ResourcesConfig,
  ): Promise<VertexAccount> {
    return this.resources.create<VertexAccountCreate, VertexAccount>(
      { ...resource, type: VertexAccounts.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: VertexAccountUpdate,
    params?: QueryParamsRetrieve<VertexAccount>,
    options?: ResourcesConfig,
  ): Promise<VertexAccount> {
    return this.resources.update<VertexAccountUpdate, VertexAccount>(
      { ...resource, type: VertexAccounts.TYPE },
      params,
      options,
    )
  ...
  async markets(
    vertexAccountId: string | VertexAccount,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `vertex_accounts/${_vertexAccountId}/markets`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `vertex_accounts/${_vertexAccountId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `vertex_accounts/${_vertexAccountId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `vertex_accounts/${_vertexAccountId}/event_stores`,
      params,
      options,
  ...
  async _refresh_token(
    id: string | VertexAccount,
    params?: QueryParamsRetrieve<VertexAccount>,
    options?: ResourcesConfig,
  ): Promise<VertexAccount> {
    return this.resources.update<VertexAccountUpdate, VertexAccount>(
      { id: typeof id === 'string' ? id : id.id, type: VertexAccounts.TYPE, _refresh_token: true },
      params,
      options,
    )
  }
