...
class CheckoutComGateways extends ApiResource<CheckoutComGateway> {
  ...
  async create(
    resource: CheckoutComGatewayCreate,
    params?: QueryParamsRetrieve<CheckoutComGateway>,
    options?: ResourcesConfig,
  ): Promise<CheckoutComGateway> {
    return this.resources.create<CheckoutComGatewayCreate, CheckoutComGateway>(
      { ...resource, type: CheckoutComGateways.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: CheckoutComGatewayUpdate,
    params?: QueryParamsRetrieve<CheckoutComGateway>,
    options?: ResourcesConfig,
  ): Promise<CheckoutComGateway> {
  ...
  async payment_methods(
    checkoutComGatewayId: string | CheckoutComGateway,
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `checkout_com_gateways/${_checkoutComGatewayId}/payment_methods`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `checkout_com_gateways/${_checkoutComGatewayId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async checkout_com_payments(
    checkoutComGatewayId: string | CheckoutComGateway,
    params?: QueryParamsList<CheckoutComPayment>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<CheckoutComPayment>> {
    const _checkoutComGatewayId = (checkoutComGatewayId as CheckoutComGateway).id || (checkoutComGatewayId as string)
    return this.resources.fetch<CheckoutComPayment>(
      { type: 'checkout_com_payments' },
      `checkout_com_gateways/${_checkoutComGatewayId}/checkout_com_payments`,
      params,
      options,
    ) as unknown as ListResponse<CheckoutComPayment>
  }
  ...
  async _disable(
    ...
    return this.resources.update<CheckoutComGatewayUpdate, CheckoutComGateway>(
      { id: typeof id === 'string' ? id : id.id, type: CheckoutComGateways.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<CheckoutComGatewayUpdate, CheckoutComGateway>(
      { id: typeof id === 'string' ? id : id.id, type: CheckoutComGateways.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _check(
    ...
    return this.resources.update<CheckoutComGatewayUpdate, CheckoutComGateway>(
      { id: typeof id === 'string' ? id : id.id, type: CheckoutComGateways.TYPE, _check: true },
      params,
      options,
    )
  }
