...
class CheckoutComGateways extends ApiResource {
	...
	async list(params?: QueryParamsList, options?: ResourcesConfig): Promise<CheckoutComGateway[] | DocWithData<CheckoutComGateway>> {
		return this.resources.list({ type: CheckoutComGateways.TYPE }, params, options)
	}

	async create(resource: CheckoutComGatewayCreate, options?: ResourcesConfig): Promise<CheckoutComGateway | DocWithData<CheckoutComGateway>> {
		return this.resources.create(Object.assign(resource, { type: CheckoutComGateways.TYPE }) , options)
	}

	async retrieve(id: string, params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<CheckoutComGateway | DocWithData<CheckoutComGateway>> {
		return this.resources.retrieve<CheckoutComGateway>({ type: CheckoutComGateways.TYPE, id }, params, options)
	}

	async update(resource: CheckoutComGatewayUpdate, options?: ResourcesConfig): Promise<CheckoutComGateway | DocWithData<CheckoutComGateway>> {
