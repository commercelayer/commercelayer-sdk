...
export type InventoryModelSort = Pick<
  InventoryModel,
  'id' | 'name' | 'strategy' | 'stock_locations_cutoff' | 'stock_reservation_cutoff'
> &
  ResourceSort
...
class InventoryModels extends ApiResource<InventoryModel> {
  ...
  async create(
    resource: InventoryModelCreate,
    params?: QueryParamsRetrieve<InventoryModel>,
    options?: ResourcesConfig,
  ): Promise<InventoryModel> {
    return this.resources.create<InventoryModelCreate, InventoryModel>(
      { ...resource, type: InventoryModels.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: InventoryModelUpdate,
    params?: QueryParamsRetrieve<InventoryModel>,
    options?: ResourcesConfig,
  ): Promise<InventoryModel> {
    return this.resources.update<InventoryModelUpdate, InventoryModel>(
      { ...resource, type: InventoryModels.TYPE },
      params,
      options,
    )
  ...
  async inventory_stock_locations(
    inventoryModelId: string | InventoryModel,
    ...
    return this.resources.fetch<InventoryStockLocation>(
      ...
      `inventory_models/${_inventoryModelId}/inventory_stock_locations`,
      params,
      options,
  ...
  async inventory_return_locations(
    ...
    return this.resources.fetch<InventoryReturnLocation>(
      ...
      `inventory_models/${_inventoryModelId}/inventory_return_locations`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `inventory_models/${_inventoryModelId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `inventory_models/${_inventoryModelId}/event_stores`,
      params,
      options,
