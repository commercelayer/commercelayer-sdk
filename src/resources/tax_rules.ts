...
/**
 * The Tax rule object is returned as part of the response body of each successful list, retrieve, create, update or delete API call to the /api/tax_rules endpoint.
 *
 * @link https://docs.commercelayer.io/core-api-reference/tax_rules/object
 */
...
class TaxRules extends ApiResource<TaxRule> {
  ...
  async create(
    resource: TaxRuleCreate,
    params?: QueryParamsRetrieve<TaxRule>,
  ...
  async manual_tax_calculator(
    taxRuleId: string | TaxRule,
    ...
    return this.resources.fetch<ManualTaxCalculator>(
      { type: 'manual_tax_calculators' },
      `tax_rules/${_taxRuleId}/manual_tax_calculator`,
      params,
      options,
    ) as unknown as ManualTaxCalculator
  }
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `tax_rules/${_taxRuleId}/event_stores`,
      params,
      options,
