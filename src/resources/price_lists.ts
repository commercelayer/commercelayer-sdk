...
class PriceLists extends ApiResource {
	...
	async list(params?: QueryParamsList, options?: ResourcesConfig): Promise<PriceList[] | DocWithData<PriceList>> {
		return this.resources.list({ type: PriceLists.TYPE }, params, options)
	}

	async create(resource: PriceListCreate, options?: ResourcesConfig): Promise<PriceList | DocWithData<PriceList>> {
		return this.resources.create(Object.assign(resource, { type: PriceLists.TYPE }) , options)
	}

	async retrieve(id: string, params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<PriceList | DocWithData<PriceList>> {
		return this.resources.retrieve<PriceList>({ type: PriceLists.TYPE, id }, params, options)
	}

	async update(resource: PriceListUpdate, options?: ResourcesConfig): Promise<PriceList | DocWithData<PriceList>> {
