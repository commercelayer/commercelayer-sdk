...
class ExternalPromotions extends ApiResource<ExternalPromotion> {
	...
	async _regenerate_shared_secret(id: string | ExternalPromotion, params?: QueryParamsRetrieve<ExternalPromotion>, options?: ResourcesConfig): Promise<ExternalPromotion> {
		return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>({ id: (typeof id === 'string')? id: id.id, type: ExternalPromotions.TYPE, _regenerate_shared_secret: true }, params, options)
	}
...
export type { ExternalPromotion, ExternalPromotionCreate, ExternalPromotions, ExternalPromotionType, ExternalPromotionUpdate }
