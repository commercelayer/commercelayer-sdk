...
class EventCallbacks extends ApiResource<EventCallback> {
  ...
  async webhook(
    eventCallbackId: string | EventCallback,
    ...
    return this.resources.fetch<Webhook>(
      { type: 'webhooks' },
      `event_callbacks/${_eventCallbackId}/webhook`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `event_callbacks/${_eventCallbackId}/event_stores`,
      params,
      options,
...
export type { EventCallback, EventCallbacks, EventCallbackType }
