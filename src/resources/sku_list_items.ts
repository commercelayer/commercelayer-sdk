...
class SkuListItems extends ApiResource {
	...
	async list(params?: QueryParamsList, options?: ResourcesConfig): Promise<SkuListItem[] | DocWithData<SkuListItem>> {
		return this.resources.list({ type: SkuListItems.TYPE }, params, options)
	}

	async create(resource: SkuListItemCreate, options?: ResourcesConfig): Promise<SkuListItem | DocWithData<SkuListItem>> {
		return this.resources.create(Object.assign(resource, { type: SkuListItems.TYPE }) , options)
	}

	async retrieve(id: string, params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<SkuListItem | DocWithData<SkuListItem>> {
		return this.resources.retrieve<SkuListItem>({ type: SkuListItems.TYPE, id }, params, options)
	}

	async update(resource: SkuListItemUpdate, options?: ResourcesConfig): Promise<SkuListItem | DocWithData<SkuListItem>> {
