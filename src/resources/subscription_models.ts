...
class SubscriptionModels extends ApiResource<SubscriptionModel> {
  ...
  async create(
    resource: SubscriptionModelCreate,
    params?: QueryParamsRetrieve<SubscriptionModel>,
    options?: ResourcesConfig,
  ): Promise<SubscriptionModel> {
    return this.resources.create<SubscriptionModelCreate, SubscriptionModel>(
      { ...resource, type: SubscriptionModels.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: SubscriptionModelUpdate,
    params?: QueryParamsRetrieve<SubscriptionModel>,
    options?: ResourcesConfig,
  ): Promise<SubscriptionModel> {
    return this.resources.update<SubscriptionModelUpdate, SubscriptionModel>(
      { ...resource, type: SubscriptionModels.TYPE },
      params,
      options,
    )
  ...
  async markets(
    subscriptionModelId: string | SubscriptionModel,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `subscription_models/${_subscriptionModelId}/markets`,
      params,
      options,
  ...
  async order_subscriptions(
    ...
    return this.resources.fetch<OrderSubscription>(
      ...
      `subscription_models/${_subscriptionModelId}/order_subscriptions`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `subscription_models/${_subscriptionModelId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `subscription_models/${_subscriptionModelId}/event_stores`,
      params,
      options,
