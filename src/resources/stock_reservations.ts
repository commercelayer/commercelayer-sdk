...
class StockReservations extends ApiResource<StockReservation> {
  ...
  async create(
    resource: StockReservationCreate,
    params?: QueryParamsRetrieve<StockReservation>,
    options?: ResourcesConfig,
  ): Promise<StockReservation> {
    return this.resources.create<StockReservationCreate, StockReservation>(
      { ...resource, type: StockReservations.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: StockReservationUpdate,
    params?: QueryParamsRetrieve<StockReservation>,
    options?: ResourcesConfig,
  ): Promise<StockReservation> {
    return this.resources.update<StockReservationUpdate, StockReservation>(
      { ...resource, type: StockReservations.TYPE },
      params,
      options,
    )
  ...
  async line_item(
    stockReservationId: string | StockReservation,
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `stock_reservations/${_stockReservationId}/line_item`,
      params,
      options,
  ...
  async order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `stock_reservations/${_stockReservationId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async stock_line_item(
    ...
    return this.resources.fetch<StockLineItem>(
      ...
      `stock_reservations/${_stockReservationId}/stock_line_item`,
      params,
      options,
    ) as unknown as StockLineItem
  }

  async stock_transfer(
    stockReservationId: string | StockReservation,
    ...
    return this.resources.fetch<StockTransfer>(
      ...
      `stock_reservations/${_stockReservationId}/stock_transfer`,
      params,
      options,
  ...
  async stock_item(
    ...
    return this.resources.fetch<StockItem>(
      { type: 'stock_items' },
      `stock_reservations/${_stockReservationId}/stock_item`,
      params,
      options,
    ) as unknown as StockItem
  }

  async reserved_stock(
    stockReservationId: string | StockReservation,
    params?: QueryParamsRetrieve<ReservedStock>,
    options?: ResourcesConfig,
  ): Promise<ReservedStock> {
    const _stockReservationId = (stockReservationId as StockReservation).id || (stockReservationId as string)
    return this.resources.fetch<ReservedStock>(
      { type: 'reserved_stocks' },
      `stock_reservations/${_stockReservationId}/reserved_stock`,
      params,
      options,
  ...
  async sku(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `stock_reservations/${_stockReservationId}/sku`,
      params,
      options,
    ) as unknown as Sku
  }
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stock_reservations/${_stockReservationId}/event_stores`,
      params,
      options,
  ...
  async _pending(
    id: string | StockReservation,
    params?: QueryParamsRetrieve<StockReservation>,
    options?: ResourcesConfig,
  ): Promise<StockReservation> {
    return this.resources.update<StockReservationUpdate, StockReservation>(
      { id: typeof id === 'string' ? id : id.id, type: StockReservations.TYPE, _pending: true },
      params,
      options,
    )
  }
