...
export type BundleSort = Pick<
  Bundle,
  'id' | 'code' | 'name' | 'currency_code' | 'price_amount_cents' | 'compare_at_amount_cents'
> &
  ResourceSort
...
class Bundles extends ApiResource<Bundle> {
  ...
  async create(
    resource: BundleCreate,
    params?: QueryParamsRetrieve<Bundle>,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `bundles/${_bundleId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async _compute_price_amount(
    id: string | Bundle,
    params?: QueryParamsRetrieve<Bundle>,
    options?: ResourcesConfig,
  ): Promise<Bundle> {
    return this.resources.update<BundleUpdate, Bundle>(
      { id: typeof id === 'string' ? id : id.id, type: Bundles.TYPE, _compute_price_amount: true },
      params,
      options,
    )
  }

  async _compute_compare_at_amount(
    id: string | Bundle,
    params?: QueryParamsRetrieve<Bundle>,
    options?: ResourcesConfig,
  ): Promise<Bundle> {
    return this.resources.update<BundleUpdate, Bundle>(
      { id: typeof id === 'string' ? id : id.id, type: Bundles.TYPE, _compute_compare_at_amount: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<BundleUpdate, Bundle>(
      { id: typeof id === 'string' ? id : id.id, type: Bundles.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<BundleUpdate, Bundle>(
      { id: typeof id === 'string' ? id : id.id, type: Bundles.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
