...
class StripePayments extends ApiResource<StripePayment> {
  ...
  async create(
    resource: StripePaymentCreate,
    params?: QueryParamsRetrieve<StripePayment>,
    options?: ResourcesConfig,
  ): Promise<StripePayment> {
    return this.resources.create<StripePaymentCreate, StripePayment>(
      { ...resource, type: StripePayments.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: StripePaymentUpdate,
    params?: QueryParamsRetrieve<StripePayment>,
    options?: ResourcesConfig,
  ): Promise<StripePayment> {
    return this.resources.update<StripePaymentUpdate, StripePayment>(
      { ...resource, type: StripePayments.TYPE },
      params,
      options,
    )
  ...
  async order(
    stripePaymentId: string | StripePayment,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `stripe_payments/${_stripePaymentId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async payment_gateway(
    ...
    return this.resources.fetch<PaymentGateway>(
      ...
      `stripe_payments/${_stripePaymentId}/payment_gateway`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stripe_payments/${_stripePaymentId}/event_stores`,
      params,
      options,
  ...
  async _update(
    id: string | StripePayment,
    params?: QueryParamsRetrieve<StripePayment>,
    options?: ResourcesConfig,
  ): Promise<StripePayment> {
    return this.resources.update<StripePaymentUpdate, StripePayment>(
      { id: typeof id === 'string' ? id : id.id, type: StripePayments.TYPE, _update: true },
      params,
      options,
    )
  }
  ...
  async _refresh(
    ...
    return this.resources.update<StripePaymentUpdate, StripePayment>(
      { id: typeof id === 'string' ? id : id.id, type: StripePayments.TYPE, _refresh: true },
      params,
      options,
    )
  }
...
export type { StripePayment, StripePaymentCreate, StripePayments, StripePaymentType, StripePaymentUpdate }
