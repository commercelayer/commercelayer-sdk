...
class AvalaraAccounts extends ApiResource<AvalaraAccount> {
  ...
  async create(
    resource: AvalaraAccountCreate,
    params?: QueryParamsRetrieve<AvalaraAccount>,
    options?: ResourcesConfig,
  ): Promise<AvalaraAccount> {
    return this.resources.create<AvalaraAccountCreate, AvalaraAccount>(
      { ...resource, type: AvalaraAccounts.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: AvalaraAccountUpdate,
    params?: QueryParamsRetrieve<AvalaraAccount>,
    options?: ResourcesConfig,
  ): Promise<AvalaraAccount> {
    return this.resources.update<AvalaraAccountUpdate, AvalaraAccount>(
      { ...resource, type: AvalaraAccounts.TYPE },
      params,
      options,
    )
  ...
  async markets(
    avalaraAccountId: string | AvalaraAccount,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `avalara_accounts/${_avalaraAccountId}/markets`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `avalara_accounts/${_avalaraAccountId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `avalara_accounts/${_avalaraAccountId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `avalara_accounts/${_avalaraAccountId}/event_stores`,
      params,
      options,
  ...
  async tax_categories(
    ...
    return this.resources.fetch<TaxCategory>(
      { type: 'tax_categories' },
      `avalara_accounts/${_avalaraAccountId}/tax_categories`,
      params,
      options,
