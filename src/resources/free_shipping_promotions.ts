...
class FreeShippingPromotions extends ApiResource {
	...
	async list(params?: QueryParamsList, options?: ResourcesConfig): Promise<FreeShippingPromotion[] | DocWithData<FreeShippingPromotion>> {
		return this.resources.list({ type: FreeShippingPromotions.TYPE }, params, options)
	}

	async create(resource: FreeShippingPromotionCreate, options?: ResourcesConfig): Promise<FreeShippingPromotion | DocWithData<FreeShippingPromotion>> {
		return this.resources.create(Object.assign(resource, { type: FreeShippingPromotions.TYPE }) , options)
	}

	async retrieve(id: string, params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<FreeShippingPromotion | DocWithData<FreeShippingPromotion>> {
		return this.resources.retrieve<FreeShippingPromotion>({ type: FreeShippingPromotions.TYPE, id }, params, options)
	}

	async update(resource: FreeShippingPromotionUpdate, options?: ResourcesConfig): Promise<FreeShippingPromotion | DocWithData<FreeShippingPromotion>> {
