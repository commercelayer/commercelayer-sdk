...
class BingGeocoders extends ApiResource<BingGeocoder> {
  ...
  async create(
    resource: BingGeocoderCreate,
    params?: QueryParamsRetrieve<BingGeocoder>,
    options?: ResourcesConfig,
  ): Promise<BingGeocoder> {
    return this.resources.create<BingGeocoderCreate, BingGeocoder>(
      { ...resource, type: BingGeocoders.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: BingGeocoderUpdate,
    params?: QueryParamsRetrieve<BingGeocoder>,
    options?: ResourcesConfig,
  ): Promise<BingGeocoder> {
    return this.resources.update<BingGeocoderUpdate, BingGeocoder>(
      { ...resource, type: BingGeocoders.TYPE },
      params,
      options,
    )
  ...
  async markets(
    bingGeocoderId: string | BingGeocoder,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `bing_geocoders/${_bingGeocoderId}/markets`,
      params,
      options,
  ...
  async addresses(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `bing_geocoders/${_bingGeocoderId}/addresses`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `bing_geocoders/${_bingGeocoderId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `bing_geocoders/${_bingGeocoderId}/event_stores`,
      params,
      options,
