...
class Organizations extends ApiResource {
	...
	async retrieve(params?: QueryParamsRetrieve, options?: ResourcesConfig): Promise<Organization | DocWithData<Organization>> {
	...
	*/
	...
	relationship(id: string): ResourceId & { type: typeof Organizations.TYPE } {
