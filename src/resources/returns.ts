...
class Returns extends ApiResource<Return> {
  ...
  async stock_location(
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `returns/${_returnId}/stock_location`,
      params,
      options,
  ...
  async origin_address(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `returns/${_returnId}/origin_address`,
      params,
      options,
    ) as unknown as Address
  }

  async destination_address(
    returnId: string | Return,
    params?: QueryParamsRetrieve<Address>,
    options?: ResourcesConfig,
  ): Promise<Address> {
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `returns/${_returnId}/destination_address`,
      params,
      options,
    ) as unknown as Address
  }
  ...
  async reference_capture(
    ...
    return this.resources.fetch<Capture>(
      { type: 'captures' },
      `returns/${_returnId}/reference_capture`,
      params,
      options,
  ...
  async reference_refund(
    ...
    return this.resources.fetch<Refund>(
      { type: 'refunds' },
      `returns/${_returnId}/reference_refund`,
      params,
      options,
  ...
  async return_line_items(
    ...
    return this.resources.fetch<ReturnLineItem>(
      ...
      `returns/${_returnId}/return_line_items`,
      params,
      options,
  ...
  async resource_errors(
    ...
    return this.resources.fetch<ResourceError>(
      ...
      `returns/${_returnId}/resource_errors`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `returns/${_returnId}/event_stores`,
      params,
      options,
  ...
  async _request(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _request: true },
      params,
      options,
    )
  }
  ...
  async _approve(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _approve: true },
      params,
      options,
    )
  }
  ...
  async _cancel(id: string | Return, params?: QueryParamsRetrieve<Return>, options?: ResourcesConfig): Promise<Return> {
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _cancel: true },
      params,
      options,
    )
  }
  ...
  async _ship(id: string | Return, params?: QueryParamsRetrieve<Return>, options?: ResourcesConfig): Promise<Return> {
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _ship: true },
      params,
      options,
    )
  }
  ...
  async _reject(id: string | Return, params?: QueryParamsRetrieve<Return>, options?: ResourcesConfig): Promise<Return> {
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _reject: true },
      params,
      options,
    )
  }
  ...
  async _receive(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _receive: true },
      params,
      options,
    )
  }
  ...
  async _restock(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _restock: true },
      params,
      options,
    )
  }
  ...
  async _archive(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _archive: true },
      params,
      options,
    )
  }
  ...
  async _unarchive(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _unarchive: true },
      params,
      options,
    )
  }
  ...
  async _refund(id: string | Return, params?: QueryParamsRetrieve<Return>, options?: ResourcesConfig): Promise<Return> {
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _refund: true },
      params,
      options,
    )
  }

  async _refund_amount_cents(
    id: string | Return,
    triggerValue: number,
    params?: QueryParamsRetrieve<Return>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _refund_amount_cents: triggerValue },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<ReturnUpdate, Return>(
      { id: typeof id === 'string' ? id : id.id, type: Returns.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
