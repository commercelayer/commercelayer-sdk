...
export type FreeGiftPromotionSort = Pick<
  FreeGiftPromotion,
  | 'id'
  | 'name'
  | 'currency_code'
...
class FreeGiftPromotions extends ApiResource<FreeGiftPromotion> {
  ...
  async create(
    resource: FreeGiftPromotionCreate,
    params?: QueryParamsRetrieve<FreeGiftPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeGiftPromotion> {
    return this.resources.create<FreeGiftPromotionCreate, FreeGiftPromotion>(
      { ...resource, type: FreeGiftPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: FreeGiftPromotionUpdate,
    params?: QueryParamsRetrieve<FreeGiftPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeGiftPromotion> {
    return this.resources.update<FreeGiftPromotionUpdate, FreeGiftPromotion>(
      { ...resource, type: FreeGiftPromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    freeGiftPromotionId: string | FreeGiftPromotion,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `free_gift_promotions/${_freeGiftPromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `free_gift_promotions/${_freeGiftPromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `free_gift_promotions/${_freeGiftPromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `free_gift_promotions/${_freeGiftPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `free_gift_promotions/${_freeGiftPromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `free_gift_promotions/${_freeGiftPromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `free_gift_promotions/${_freeGiftPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `free_gift_promotions/${_freeGiftPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `free_gift_promotions/${_freeGiftPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `free_gift_promotions/${_freeGiftPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `free_gift_promotions/${_freeGiftPromotionId}/event_stores`,
      params,
      options,
  ...
  async skus(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `free_gift_promotions/${_freeGiftPromotionId}/skus`,
      params,
      options,
  ...
  async _disable(
    id: string | FreeGiftPromotion,
    params?: QueryParamsRetrieve<FreeGiftPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeGiftPromotion> {
    return this.resources.update<FreeGiftPromotionUpdate, FreeGiftPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeGiftPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<FreeGiftPromotionUpdate, FreeGiftPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeGiftPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<FreeGiftPromotionUpdate, FreeGiftPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeGiftPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<FreeGiftPromotionUpdate, FreeGiftPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeGiftPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
