...
export type ShipmentSort = Pick<Shipment, 'id' | 'cost_amount_cents' | 'get_rates_completed_at' | 'get_rates_started_at' | 'number' | 'on_hold_at' | 'packing_at' | 'picking_at' | 'purchase_completed_at' | 'purchase_failed_at' | 'purchase_started_at' | 'ready_to_ship_at' | 'shipped_at' | 'status'> & ResourceSort
// export type ShipmentFilter = Pick<Shipment, 'id' | 'cost_amount_cents' | 'get_rates_completed_at' | 'get_rates_started_at' | 'number' | 'on_hold_at' | 'packing_at' | 'picking_at' | 'purchase_completed_at' | 'purchase_failed_at' | 'purchase_started_at' | 'ready_to_ship_at' | 'shipped_at' | 'status'> & ResourceFilter
