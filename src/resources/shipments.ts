...
class Shipments extends ApiResource<Shipment> {
  ...
  async order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `shipments/${_shipmentId}/order`,
      params,
      options,
    ) as unknown as Order
  }

  async shipping_category(
    shipmentId: string | Shipment,
    params?: QueryParamsRetrieve<ShippingCategory>,
    options?: ResourcesConfig,
  ): Promise<ShippingCategory> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<ShippingCategory>(
      { type: 'shipping_categories' },
      `shipments/${_shipmentId}/shipping_category`,
      params,
      options,
    ) as unknown as ShippingCategory
  }

  async inventory_stock_location(
    shipmentId: string | Shipment,
    params?: QueryParamsRetrieve<InventoryStockLocation>,
    options?: ResourcesConfig,
  ): Promise<InventoryStockLocation> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<InventoryStockLocation>(
      { type: 'inventory_stock_locations' },
      `shipments/${_shipmentId}/inventory_stock_location`,
      params,
      options,
    ) as unknown as InventoryStockLocation
  }
  ...
  async stock_location(
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `shipments/${_shipmentId}/stock_location`,
      params,
      options,
    ) as unknown as StockLocation
  }

  async origin_address(
    shipmentId: string | Shipment,
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `shipments/${_shipmentId}/origin_address`,
      params,
      options,
  ...
  async shipping_address(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `shipments/${_shipmentId}/shipping_address`,
      params,
      options,
    ) as unknown as Address
  }
  ...
  async shipping_method(
    ...
    return this.resources.fetch<ShippingMethod>(
      ...
      `shipments/${_shipmentId}/shipping_method`,
      params,
      options,
    ) as unknown as ShippingMethod
  }

  async delivery_lead_time(
    shipmentId: string | Shipment,
    params?: QueryParamsRetrieve<DeliveryLeadTime>,
    options?: ResourcesConfig,
  ): Promise<DeliveryLeadTime> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<DeliveryLeadTime>(
      { type: 'delivery_lead_times' },
      `shipments/${_shipmentId}/delivery_lead_time`,
      params,
      options,
    ) as unknown as DeliveryLeadTime
  }

  async pickup(
    shipmentId: string | Shipment,
    params?: QueryParamsRetrieve<Pickup>,
    options?: ResourcesConfig,
  ): Promise<Pickup> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<Pickup>(
      { type: 'pickups' },
      `shipments/${_shipmentId}/pickup`,
      params,
      options,
  ...
  async stock_line_items(
    ...
    return this.resources.fetch<StockLineItem>(
      ...
      `shipments/${_shipmentId}/stock_line_items`,
      params,
      options,
  ...
  async stock_transfers(
    ...
    return this.resources.fetch<StockTransfer>(
      ...
      `shipments/${_shipmentId}/stock_transfers`,
      params,
      options,
  ...
  async line_items(
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `shipments/${_shipmentId}/line_items`,
      params,
      options,
    ) as unknown as ListResponse<LineItem>
  }

  async available_shipping_methods(
    shipmentId: string | Shipment,
    params?: QueryParamsList<ShippingMethod>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<ShippingMethod>> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<ShippingMethod>(
      { type: 'shipping_methods' },
      `shipments/${_shipmentId}/available_shipping_methods`,
      params,
      options,
    ) as unknown as ListResponse<ShippingMethod>
  }

  async carrier_accounts(
    shipmentId: string | Shipment,
    params?: QueryParamsList<CarrierAccount>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<CarrierAccount>> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<CarrierAccount>(
      { type: 'carrier_accounts' },
      `shipments/${_shipmentId}/carrier_accounts`,
      params,
      options,
    ) as unknown as ListResponse<CarrierAccount>
  }

  async parcels(
    shipmentId: string | Shipment,
    params?: QueryParamsList<Parcel>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Parcel>> {
    const _shipmentId = (shipmentId as Shipment).id || (shipmentId as string)
    return this.resources.fetch<Parcel>(
      { type: 'parcels' },
      `shipments/${_shipmentId}/parcels`,
      params,
      options,
    ) as unknown as ListResponse<Parcel>
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `shipments/${_shipmentId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `shipments/${_shipmentId}/event_stores`,
      params,
      options,
  ...
  async _upcoming(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _upcoming: true },
      params,
      options,
    )
  }
  ...
  async _cancel(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _cancel: true },
      params,
      options,
    )
  }
  ...
  async _on_hold(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _on_hold: true },
      params,
      options,
    )
  }
  ...
  async _picking(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _picking: true },
      params,
      options,
    )
  }
  ...
  async _packing(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _packing: true },
      params,
      options,
    )
  }

  async _ready_to_ship(
    id: string | Shipment,
    params?: QueryParamsRetrieve<Shipment>,
    options?: ResourcesConfig,
  ): Promise<Shipment> {
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _ready_to_ship: true },
      params,
      options,
    )
  }
  ...
  async _ship(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _ship: true },
      params,
      options,
    )
  }
  ...
  async _deliver(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _deliver: true },
      params,
      options,
    )
  }

  async _reserve_stock(
    id: string | Shipment,
    params?: QueryParamsRetrieve<Shipment>,
    options?: ResourcesConfig,
  ): Promise<Shipment> {
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _reserve_stock: true },
      params,
      options,
    )
  }

  async _release_stock(
    id: string | Shipment,
    params?: QueryParamsRetrieve<Shipment>,
    options?: ResourcesConfig,
  ): Promise<Shipment> {
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _release_stock: true },
      params,
      options,
    )
  }

  async _decrement_stock(
    id: string | Shipment,
    params?: QueryParamsRetrieve<Shipment>,
    options?: ResourcesConfig,
  ): Promise<Shipment> {
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _decrement_stock: true },
      params,
      options,
    )
  }
  ...
  async _get_rates(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _get_rates: true },
      params,
      options,
    )
  }
  ...
  async _purchase(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _purchase: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<ShipmentUpdate, Shipment>(
      { id: typeof id === 'string' ? id : id.id, type: Shipments.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
