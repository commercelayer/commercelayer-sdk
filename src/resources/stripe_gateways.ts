...
class StripeGateways extends ApiResource<StripeGateway> {
  ...
  async create(
    resource: StripeGatewayCreate,
    params?: QueryParamsRetrieve<StripeGateway>,
    options?: ResourcesConfig,
  ): Promise<StripeGateway> {
    return this.resources.create<StripeGatewayCreate, StripeGateway>(
      { ...resource, type: StripeGateways.TYPE },
      params,
      options,
    )
  }
  ...
  async payment_methods(
    stripeGatewayId: string | StripeGateway,
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `stripe_gateways/${_stripeGatewayId}/payment_methods`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stripe_gateways/${_stripeGatewayId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async stripe_payments(
    stripeGatewayId: string | StripeGateway,
    params?: QueryParamsList<StripePayment>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<StripePayment>> {
    const _stripeGatewayId = (stripeGatewayId as StripeGateway).id || (stripeGatewayId as string)
    return this.resources.fetch<StripePayment>(
      { type: 'stripe_payments' },
      `stripe_gateways/${_stripeGatewayId}/stripe_payments`,
      params,
      options,
    ) as unknown as ListResponse<StripePayment>
  }
  ...
  async _disable(
    ...
    return this.resources.update<StripeGatewayUpdate, StripeGateway>(
      { id: typeof id === 'string' ? id : id.id, type: StripeGateways.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<StripeGatewayUpdate, StripeGateway>(
      { id: typeof id === 'string' ? id : id.id, type: StripeGateways.TYPE, _enable: true },
      params,
      options,
    )
  }
