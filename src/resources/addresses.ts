...
class Addresses extends ApiResource<Address> {
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `addresses/${_addressId}/event_stores`,
      params,
      options,
  ...
  async _add_tags(
    ...
    return this.resources.update<AddressUpdate, Address>(
      { id: typeof id === 'string' ? id : id.id, type: Addresses.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<AddressUpdate, Address>(
      { id: typeof id === 'string' ? id : id.id, type: Addresses.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
...
export type { Address, AddressCreate, Addresses, AddressType, AddressUpdate }
