...
export type CouponSort = Pick<
  Coupon,
  'id' | 'code' | 'customer_single_use' | 'usage_limit' | 'usage_count' | 'expires_at'
> &
  ResourceSort
...
class Coupons extends ApiResource<Coupon> {
  ...
  async create(
    resource: CouponCreate,
    params?: QueryParamsRetrieve<Coupon>,
  ...
  async promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `coupons/${_couponId}/promotion_rule`,
      params,
      options,
    ) as unknown as CouponCodesPromotionRule
  }

  async coupon_recipient(
    couponId: string | Coupon,
    params?: QueryParamsRetrieve<CouponRecipient>,
    options?: ResourcesConfig,
  ): Promise<CouponRecipient> {
    const _couponId = (couponId as Coupon).id || (couponId as string)
    return this.resources.fetch<CouponRecipient>(
      { type: 'coupon_recipients' },
      `coupons/${_couponId}/coupon_recipient`,
      params,
      options,
    ) as unknown as CouponRecipient
  }
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `coupons/${_couponId}/event_stores`,
      params,
      options,
  ...
  async _add_tags(
    ...
    return this.resources.update<CouponUpdate, Coupon>(
      { id: typeof id === 'string' ? id : id.id, type: Coupons.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<CouponUpdate, Coupon>(
      { id: typeof id === 'string' ? id : id.id, type: Coupons.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
