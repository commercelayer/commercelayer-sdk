...
class Stores extends ApiResource<Store> {
  ...
  async stock_location(
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `stores/${_storeId}/stock_location`,
      params,
      options,
  ...
  async payment_methods(
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `stores/${_storeId}/payment_methods`,
      params,
      options,
