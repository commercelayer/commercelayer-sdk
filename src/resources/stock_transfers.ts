...
export type StockTransferSort = Pick<
  StockTransfer,
  | 'id'
  | 'number'
  | 'status'
...
class StockTransfers extends ApiResource<StockTransfer> {
  ...
  async create(
    resource: StockTransferCreate,
    params?: QueryParamsRetrieve<StockTransfer>,
    options?: ResourcesConfig,
  ): Promise<StockTransfer> {
    return this.resources.create<StockTransferCreate, StockTransfer>(
      { ...resource, type: StockTransfers.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: StockTransferUpdate,
    params?: QueryParamsRetrieve<StockTransfer>,
    options?: ResourcesConfig,
  ): Promise<StockTransfer> {
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { ...resource, type: StockTransfers.TYPE },
      params,
      options,
    )
  ...
  async sku(
    stockTransferId: string | StockTransfer,
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `stock_transfers/${_stockTransferId}/sku`,
      params,
      options,
    ) as unknown as Sku
  }

  async origin_stock_location(
    stockTransferId: string | StockTransfer,
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `stock_transfers/${_stockTransferId}/origin_stock_location`,
      params,
      options,
    ) as unknown as StockLocation
  }

  async destination_stock_location(
    stockTransferId: string | StockTransfer,
    params?: QueryParamsRetrieve<StockLocation>,
    options?: ResourcesConfig,
  ): Promise<StockLocation> {
    ...
    return this.resources.fetch<StockLocation>(
      { type: 'stock_locations' },
      `stock_transfers/${_stockTransferId}/destination_stock_location`,
      params,
      options,
    ) as unknown as StockLocation
  }
  ...
  async shipment(
    ...
    return this.resources.fetch<Shipment>(
      { type: 'shipments' },
      `stock_transfers/${_stockTransferId}/shipment`,
      params,
      options,
  ...
  async line_item(
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `stock_transfers/${_stockTransferId}/line_item`,
      params,
      options,
  ...
  async stock_reservation(
    ...
    return this.resources.fetch<StockReservation>(
      ...
      `stock_transfers/${_stockTransferId}/stock_reservation`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `stock_transfers/${_stockTransferId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `stock_transfers/${_stockTransferId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stock_transfers/${_stockTransferId}/event_stores`,
      params,
      options,
  ...
  async _upcoming(
    id: string | StockTransfer,
    params?: QueryParamsRetrieve<StockTransfer>,
    options?: ResourcesConfig,
  ): Promise<StockTransfer> {
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _upcoming: true },
      params,
      options,
    )
  }
  ...
  async _on_hold(
    ...
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _on_hold: true },
      params,
      options,
    )
  }
  ...
  async _picking(
    ...
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _picking: true },
      params,
      options,
    )
  }
  ...
  async _in_transit(
    ...
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _in_transit: true },
      params,
      options,
    )
  }
  ...
  async _complete(
    ...
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _complete: true },
      params,
      options,
    )
  }
  ...
  async _cancel(
    ...
    return this.resources.update<StockTransferUpdate, StockTransfer>(
      { id: typeof id === 'string' ? id : id.id, type: StockTransfers.TYPE, _cancel: true },
      params,
      options,
    )
  }
