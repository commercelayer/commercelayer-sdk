...
class DeliveryLeadTimes extends ApiResource<DeliveryLeadTime> {
  ...
  async create(
    resource: DeliveryLeadTimeCreate,
    params?: QueryParamsRetrieve<DeliveryLeadTime>,
    options?: ResourcesConfig,
  ): Promise<DeliveryLeadTime> {
    return this.resources.create<DeliveryLeadTimeCreate, DeliveryLeadTime>(
      { ...resource, type: DeliveryLeadTimes.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: DeliveryLeadTimeUpdate,
    params?: QueryParamsRetrieve<DeliveryLeadTime>,
    options?: ResourcesConfig,
  ): Promise<DeliveryLeadTime> {
    return this.resources.update<DeliveryLeadTimeUpdate, DeliveryLeadTime>(
      { ...resource, type: DeliveryLeadTimes.TYPE },
      params,
      options,
    )
  ...
  async stock_location(
    deliveryLeadTimeId: string | DeliveryLeadTime,
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `delivery_lead_times/${_deliveryLeadTimeId}/stock_location`,
      params,
      options,
  ...
  async shipping_method(
    ...
    return this.resources.fetch<ShippingMethod>(
      ...
      `delivery_lead_times/${_deliveryLeadTimeId}/shipping_method`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `delivery_lead_times/${_deliveryLeadTimeId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `delivery_lead_times/${_deliveryLeadTimeId}/event_stores`,
      params,
      options,
