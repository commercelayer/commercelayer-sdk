...
class CommerceLayerBundle extends CommerceLayerClient {
  ...
  get adyen_gateways(): api.AdyenGateways {
    return api.adyen_gateways
  }
  get adyen_payments(): api.AdyenPayments {
    return api.adyen_payments
  }
