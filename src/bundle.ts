...
class CommerceLayerBundle extends CommerceLayerClient {
  ...
  // ##__CL_RESOURCES_ACCESSORS_ONLY_TEMPLATE:: ##__TAB__##get ##__RESOURCE_TYPE__##(): api.##__RESOURCE_CLASS__## { return api.##__RESOURCE_TYPE__## }
	...
	get billing_info_validation_rules(): api.BillingInfoValidationRules { return api.billing_info_validation_rules }
	...
	get order_validation_rules(): api.OrderValidationRules { return api.order_validation_rules }
	...
	get shipment_line_items(): api.ShipmentLineItems { return api.shipment_line_items }
