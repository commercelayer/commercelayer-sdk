...
const OPEN_API_SCHEMA_VERSION = '7.9.11'
...
class CommerceLayerClient {
	...
	get discount_engine_items(): api.DiscountEngineItems { return this.#discount_engine_items || (this.#discount_engine_items = new api.DiscountEngineItems(this.#adapter)) }
	get discount_engines(): api.DiscountEngines { return this.#discount_engines || (this.#discount_engines = new api.DiscountEngines(this.#adapter)) }
	get easypost_pickups(): api.EasypostPickups { return this.#easypost_pickups || (this.#easypost_pickups = new api.EasypostPickups(this.#adapter)) }
	...
	get event_stores(): api.EventStores { return this.#event_stores || (this.#event_stores = new api.EventStores(this.#adapter)) }
	...
	get notifications(): api.Notifications { return this.#notifications || (this.#notifications = new api.Notifications(this.#adapter)) }
	...
	get pickups(): api.Pickups { return this.#pickups || (this.#pickups = new api.Pickups(this.#adapter)) }
	...
	get stores(): api.Stores { return this.#stores || (this.#stores = new api.Stores(this.#adapter)) }
	...
	get stripe_tax_accounts(): api.StripeTaxAccounts { return this.#stripe_tax_accounts || (this.#stripe_tax_accounts = new api.StripeTaxAccounts(this.#adapter)) }
	...
	get talon_one_accounts(): api.TalonOneAccounts { return this.#talon_one_accounts || (this.#talon_one_accounts = new api.TalonOneAccounts(this.#adapter)) }
	...
	get vertex_accounts(): api.VertexAccounts { return this.#vertex_accounts || (this.#vertex_accounts = new api.VertexAccounts(this.#adapter)) }
