...
describe('Returns resource', () => {
  ...
  */
  ...
  test(resourceType + '.destination_address', async () => {
    ...
    await returns
      .destination_address(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.reference_capture', async () => {
    ...
    await returns
      .reference_capture(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.reference_refund', async () => {
    ...
    await returns
      .reference_refund(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.return_line_items', async () => {
    ...
    await returns
      .return_line_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._request', async () => {
    ...
    await returns
      ._request(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._receive', async () => {
    ...
    await returns
      ._receive(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._restock', async () => {
    ...
    await returns
      ._restock(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._refund_amount_cents', async () => {
    ...
    await returns
      ._refund_amount_cents(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
