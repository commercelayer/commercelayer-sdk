...
import { checkout_com_gateways, checkout_com_payments } from '../api'
import type { CheckoutComGateway } from '../model'
...
describe('CheckoutComGateways resource', () => {
  ...
  */
  ...
  test(resourceType + '.checkout_com_payments', async () => {
    ...
    await checkout_com_gateways
      .checkout_com_payments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
