...
describe('Users resource', () => {
  ...
  test(resourceType + '.type', async () => {
    ...
    expect(users.isUser(resource)).toBeTruthy()
  ...
  test(resourceType + '.relationship', async () => {
    const relId = users.relationship(TestData.id)
    expect(isDeepStrictEqual(relId, { id: TestData.id, type: resourceType }))

    const relResId = users.relationship({ id: TestData.id, type: resourceType })
  ...
  test(resourceType + '.parse', async () => {
    ...
    const res = users.parse(payload) as User
  ...
  */
  ...
  test(resourceType + '.instance', async () => {
    expect(users)
    expect(users.type()).toBe(resourceType)
  })
  /* spec.instance stop */
