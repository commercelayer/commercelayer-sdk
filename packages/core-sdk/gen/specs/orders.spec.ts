...
import { addresses, customers, markets, orders, stores, tags } from '../api'
...
describe('Orders resource', () => {
  ...
  */
  ...
  test(resourceType + '.store', async () => {
    ...
    await orders
      .store(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.default_shipping_method', async () => {
    ...
    await orders
      .default_shipping_method(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.default_payment_method', async () => {
    ...
    await orders
      .default_payment_method(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.available_payment_methods', async () => {
    ...
    await orders
      .available_payment_methods(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.available_customer_payment_sources', async () => {
    ...
    await orders
      .available_customer_payment_sources(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.available_free_skus', async () => {
    ...
    await orders
      .available_free_skus(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.available_free_bundles', async () => {
    ...
    await orders
      .available_free_bundles(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.payment_method', async () => {
    ...
    await orders
      .payment_method(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.discount_engine_item', async () => {
    ...
    await orders
      .discount_engine_item(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.line_items', async () => {
    ...
    await orders
      .line_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.line_item_options', async () => {
    ...
    await orders
      .line_item_options(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_reservations', async () => {
    ...
    await orders
      .stock_reservations(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_line_items', async () => {
    ...
    await orders
      .stock_line_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_transfers', async () => {
    ...
    await orders
      .stock_transfers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.shipments', async () => {
    ...
    await orders
      .shipments(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.payment_options', async () => {
    ...
    await orders
      .payment_options(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.authorizations', async () => {
    ...
    await orders
      .authorizations(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.captures', async () => {
    ...
    await orders
      .captures(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.voids', async () => {
    ...
    await orders
      .voids(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.refunds', async () => {
    ...
    await orders
      .refunds(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.returns', async () => {
    ...
    await orders
      .returns(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.order_subscription', async () => {
    ...
    await orders
      .order_subscription(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.order_factories', async () => {
    ...
    await orders
      .order_factories(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.recurring_order_copies', async () => {
    ...
    await orders
      .recurring_order_copies(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.notifications', async () => {
    ...
    await orders
      .notifications(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.links', async () => {
    ...
    await orders
      .links(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.tags', async () => {
    ...
    await orders
      .tags(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._archive', async () => {
    ...
    await orders
      ._archive(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._unarchive', async () => {
    ...
    await orders
      ._unarchive(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._pending', async () => {
    ...
    await orders
      ._pending(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._approve', async () => {
    ...
    await orders
      ._approve(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._approve_and_capture', async () => {
    ...
    await orders
      ._approve_and_capture(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._authorize', async () => {
    ...
    await orders
      ._authorize(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._authorization_amount_cents', async () => {
    ...
    await orders
      ._authorization_amount_cents(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._capture', async () => {
    ...
    await orders
      ._capture(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._fulfill', async () => {
    ...
    await orders
      ._fulfill(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._update_taxes', async () => {
    ...
    await orders
      ._update_taxes(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._nullify_payment_source', async () => {
    ...
    await orders
      ._nullify_payment_source(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._fix_payment_source', async () => {
    ...
    await orders
      ._fix_payment_source(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._billing_address_clone_id', async () => {
    ...
    await orders
      ._billing_address_clone_id(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._shipping_address_clone_id', async () => {
    ...
    await orders
      ._shipping_address_clone_id(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._customer_payment_source_id', async () => {
    ...
    await orders
      ._customer_payment_source_id(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._shipping_address_same_as_billing', async () => {
    ...
    await orders
      ._shipping_address_same_as_billing(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._billing_address_same_as_shipping', async () => {
    ...
    await orders
      ._billing_address_same_as_shipping(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._commit_invoice', async () => {
    ...
    await orders
      ._commit_invoice(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._refund_invoice', async () => {
    ...
    await orders
      ._refund_invoice(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._save_payment_source_to_customer_wallet', async () => {
    ...
    await orders
      ._save_payment_source_to_customer_wallet(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._save_shipping_address_to_customer_address_book', async () => {
    ...
    await orders
      ._save_shipping_address_to_customer_address_book(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._save_billing_address_to_customer_address_book', async () => {
    ...
    await orders
      ._save_billing_address_to_customer_address_book(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._refresh_prices', async () => {
    ...
    await orders
      ._refresh_prices(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._validate', async () => {
    ...
    await orders
      ._validate(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._create_subscriptions', async () => {
    ...
    await orders
      ._create_subscriptions(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._start_editing', async () => {
    ...
    await orders
      ._start_editing(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._stop_editing', async () => {
    ...
    await orders
      ._stop_editing(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._add_tags', async () => {
    ...
    await orders
      ._add_tags(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._remove_tags', async () => {
    ...
    await orders
      ._remove_tags(id, triggerValue, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
