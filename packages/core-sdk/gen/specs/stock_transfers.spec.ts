...
import { line_items, shipments, skus, stock_locations, stock_transfers } from '../api'
import type { StockTransfer } from '../model'
...
describe('StockTransfers resource', () => {
  ...
  */
  ...
  test(resourceType + '.origin_stock_location', async () => {
    ...
    await stock_transfers
      .origin_stock_location(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.destination_stock_location', async () => {
    ...
    await stock_transfers
      .destination_stock_location(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._in_transit', async () => {
    ...
    await stock_transfers
      ._in_transit(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._complete', async () => {
    ...
    await stock_transfers
      ._complete(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
