...
import { coupon_codes_promotion_rules, coupon_recipients, coupons, tags } from '../api'
...
describe('Coupons resource', () => {
  ...
  */
  ...
  test(resourceType + '.promotion_rule', async () => {
    ...
    await coupons
      .promotion_rule(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.coupon_recipient', async () => {
    ...
    await coupons
      .coupon_recipient(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
