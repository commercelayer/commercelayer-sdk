...
import type { ShippingMethod } from '../model'
...
describe('ShippingMethods resource', () => {
  ...
  */
  ...
  test(resourceType + '.shipping_zone', async () => {
    ...
    await shipping_methods
      .shipping_zone(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.delivery_lead_time_for_shipment', async () => {
    ...
    await shipping_methods
      .delivery_lead_time_for_shipment(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.shipping_method_tiers', async () => {
    ...
    await shipping_methods
      .shipping_method_tiers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.shipping_weight_tiers', async () => {
    ...
    await shipping_methods
      .shipping_weight_tiers(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
