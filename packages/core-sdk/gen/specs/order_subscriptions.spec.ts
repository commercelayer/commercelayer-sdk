...
import { markets, order_subscriptions, orders, payment_settings, payment_wallets, tags } from '../api'
import type { OrderSubscription } from '../model'
...
describe('OrderSubscriptions resource', () => {
  ...
  */
  ...
  test(resourceType + '.subscription_model', async () => {
    ...
    await order_subscriptions
      .subscription_model(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.source_order', async () => {
    ...
    await order_subscriptions
      .source_order(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.customer_payment_source', async () => {
    ...
    await order_subscriptions
      .customer_payment_source(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.order_subscription_items', async () => {
    ...
    await order_subscriptions
      .order_subscription_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._convert', async () => {
    ...
    await order_subscriptions
      ._convert(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
