...
import { line_item_options, line_items, sku_options, tags } from '../api'
import type { LineItemOption } from '../model'
...
describe('LineItemOptions resource', () => {
  ...
  */
  ...
  test(resourceType + '.sku_option', async () => {
    ...
    await line_item_options
      .sku_option(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
