...
describe('Shipments resource', () => {
  ...
  */
  ...
  test(resourceType + '.shipping_category', async () => {
    ...
    await shipments
      .shipping_category(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.inventory_stock_location', async () => {
    ...
    await shipments
      .inventory_stock_location(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.stock_location', async () => {
    ...
    await shipments
      .stock_location(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.origin_address', async () => {
    ...
    await shipments
      .origin_address(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.shipping_method', async () => {
    ...
    await shipments
      .shipping_method(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.delivery_lead_time', async () => {
    ...
    await shipments
      .delivery_lead_time(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.pickup', async () => {
    ...
    await shipments
      .pickup(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.available_shipping_methods', async () => {
    ...
    await shipments
      .available_shipping_methods(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.carrier_accounts', async () => {
    ...
    await shipments
      .carrier_accounts(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.parcels', async () => {
    ...
    await shipments
      .parcels(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._upcoming', async () => {
    ...
    await shipments
      ._upcoming(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._on_hold', async () => {
    ...
    await shipments
      ._on_hold(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._picking', async () => {
    ...
    await shipments
      ._picking(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._packing', async () => {
    ...
    await shipments
      ._packing(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._ready_to_ship', async () => {
    ...
    await shipments
      ._ready_to_ship(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._deliver', async () => {
    ...
    await shipments
      ._deliver(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._reserve_stock', async () => {
    ...
    await shipments
      ._reserve_stock(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._release_stock', async () => {
    ...
    await shipments
      ._release_stock(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._decrement_stock', async () => {
    ...
    await shipments
      ._decrement_stock(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._get_rates', async () => {
    ...
    await shipments
      ._get_rates(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '._purchase', async () => {
    ...
    await shipments
      ._purchase(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
