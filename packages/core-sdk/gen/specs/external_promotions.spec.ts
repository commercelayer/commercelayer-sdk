...
import { external_promotions, markets, sku_lists, tags } from '../api'
import type { ExternalPromotion } from '../model'
...
describe('ExternalPromotions resource', () => {
  ...
  */
  ...
  test(resourceType + '.order_amount_promotion_rule', async () => {
    ...
    await external_promotions
      .order_amount_promotion_rule(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.sku_list_promotion_rule', async () => {
    ...
    await external_promotions
      .sku_list_promotion_rule(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.coupon_codes_promotion_rule', async () => {
    ...
    await external_promotions
      .coupon_codes_promotion_rule(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.custom_promotion_rule', async () => {
    ...
    await external_promotions
      .custom_promotion_rule(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.sku_list', async () => {
    ...
    await external_promotions
      .sku_list(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.coupons', async () => {
    ...
    await external_promotions
      .coupons(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.skus', async () => {
    ...
    await external_promotions
      .skus(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
