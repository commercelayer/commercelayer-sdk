...
export type ShippingMethodSort = Pick<
  ShippingMethod,
  | 'id'
  | 'name'
  | 'scheme'
...
class ShippingMethods extends ApiResource<ShippingMethod> {
  ...
  async create(
    resource: ShippingMethodCreate,
    params?: QueryParamsRetrieve<ShippingMethod>,
    options?: ResourcesConfig,
  ): Promise<ShippingMethod> {
    return this.resources.create<ShippingMethodCreate, ShippingMethod>(
      { ...resource, type: ShippingMethods.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: ShippingMethodUpdate,
    params?: QueryParamsRetrieve<ShippingMethod>,
    options?: ResourcesConfig,
  ): Promise<ShippingMethod> {
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { ...resource, type: ShippingMethods.TYPE },
      params,
      options,
    )
  ...
  async market(
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `shipping_methods/${_shippingMethodId}/market`,
      params,
      options,
  ...
  async shipping_zone(
    ...
    const _shippingMethodId = (shippingMethodId as ShippingMethod).id || (shippingMethodId as string)
    return this.resources.fetch<ShippingZone>(
      { type: 'shipping_zones' },
      `shipping_methods/${_shippingMethodId}/shipping_zone`,
      params,
      options,
  ...
  async shipping_category(
    ...
    return this.resources.fetch<ShippingCategory>(
      ...
      `shipping_methods/${_shippingMethodId}/shipping_category`,
      params,
      options,
  ...
  async stock_location(
    ...
    return this.resources.fetch<StockLocation>(
      ...
      `shipping_methods/${_shippingMethodId}/stock_location`,
      params,
      options,
    ) as unknown as StockLocation
  }

  async delivery_lead_time_for_shipment(
    shippingMethodId: string | ShippingMethod,
    ...
    return this.resources.fetch<DeliveryLeadTime>(
      ...
      `shipping_methods/${_shippingMethodId}/delivery_lead_time_for_shipment`,
      params,
      options,
    ) as unknown as DeliveryLeadTime
  }

  async shipping_method_tiers(
    shippingMethodId: string | ShippingMethod,
    params?: QueryParamsList<ShippingMethodTier>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<ShippingMethodTier>> {
    const _shippingMethodId = (shippingMethodId as ShippingMethod).id || (shippingMethodId as string)
    return this.resources.fetch<ShippingMethodTier>(
      { type: 'shipping_method_tiers' },
      `shipping_methods/${_shippingMethodId}/shipping_method_tiers`,
      params,
      options,
    ) as unknown as ListResponse<ShippingMethodTier>
  }

  async shipping_weight_tiers(
    shippingMethodId: string | ShippingMethod,
    params?: QueryParamsList<ShippingWeightTier>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<ShippingWeightTier>> {
    const _shippingMethodId = (shippingMethodId as ShippingMethod).id || (shippingMethodId as string)
    return this.resources.fetch<ShippingWeightTier>(
      { type: 'shipping_weight_tiers' },
      `shipping_methods/${_shippingMethodId}/shipping_weight_tiers`,
      params,
      options,
    ) as unknown as ListResponse<ShippingWeightTier>
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `shipping_methods/${_shippingMethodId}/attachments`,
      params,
      options,
  ...
  async notifications(
    ...
    return this.resources.fetch<Notification>(
      { type: 'notifications' },
      `shipping_methods/${_shippingMethodId}/notifications`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `shipping_methods/${_shippingMethodId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `shipping_methods/${_shippingMethodId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `shipping_methods/${_shippingMethodId}/event_stores`,
      params,
      options,
  ...
  async _disable(
    id: string | ShippingMethod,
    params?: QueryParamsRetrieve<ShippingMethod>,
    options?: ResourcesConfig,
  ): Promise<ShippingMethod> {
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _reset_circuit(
    ...
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _reset_circuit: true },
      params,
      options,
    )
  }
  ...
  async _regenerate_shared_secret(
    ...
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _regenerate_shared_secret: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<ShippingMethodUpdate, ShippingMethod>(
      { id: typeof id === 'string' ? id : id.id, type: ShippingMethods.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
