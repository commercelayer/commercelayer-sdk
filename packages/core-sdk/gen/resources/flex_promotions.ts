...
/**
 * The Flex promotion object is returned as part of the response body of each successful list, retrieve, create, update or delete API call to the /api/flex_promotions endpoint.
 *
 * @link https://docs.commercelayer.io/core-api-reference/flex_promotions/object
 */
...
class FlexPromotions extends ApiResource<FlexPromotion> {
  ...
  async create(
    resource: FlexPromotionCreate,
    params?: QueryParamsRetrieve<FlexPromotion>,
    options?: ResourcesConfig,
  ): Promise<FlexPromotion> {
    return this.resources.create<FlexPromotionCreate, FlexPromotion>(
      { ...resource, type: FlexPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: FlexPromotionUpdate,
    params?: QueryParamsRetrieve<FlexPromotion>,
    options?: ResourcesConfig,
  ): Promise<FlexPromotion> {
    return this.resources.update<FlexPromotionUpdate, FlexPromotion>(
      { ...resource, type: FlexPromotions.TYPE },
      params,
      options,
    )
  ...
  async coupon_codes_promotion_rule(
    flexPromotionId: string | FlexPromotion,
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `flex_promotions/${_flexPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `flex_promotions/${_flexPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `flex_promotions/${_flexPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `flex_promotions/${_flexPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `flex_promotions/${_flexPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `flex_promotions/${_flexPromotionId}/event_stores`,
      params,
      options,
  ...
  async _disable(
    id: string | FlexPromotion,
    params?: QueryParamsRetrieve<FlexPromotion>,
    options?: ResourcesConfig,
  ): Promise<FlexPromotion> {
    return this.resources.update<FlexPromotionUpdate, FlexPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FlexPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<FlexPromotionUpdate, FlexPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FlexPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<FlexPromotionUpdate, FlexPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FlexPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<FlexPromotionUpdate, FlexPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FlexPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
