...
interface PaymentSession extends Resource {
  ...
  /**
   * The payment session status. One of 'unpaid' (default), 'authorized', 'voided', 'paid', 'partially_paid', 'refunded', or 'partially_refunded'.
   * @example ```"unpaid"```
   */
  status: 'unpaid' | 'authorized' | 'voided' | 'paid' | 'partially_paid' | 'refunded' | 'partially_refunded'
  /**
