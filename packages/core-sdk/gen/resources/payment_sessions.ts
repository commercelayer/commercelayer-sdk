...
> &
  ResourceSort
// export type PaymentSessionFilter = Pick<PaymentSession, 'id' | 'status' | 'amount_cents' | 'currency_code' | 'gift_card_code' | 'token' | 'expires_at' | 'balance_exceeded_at'> & ResourceFilter
