...
export type PriceFrequencyTierSort = Pick<PriceFrequencyTier, 'id' | 'name' | 'up_to' | 'price_amount_cents'> &
  ResourceSort
...
class PriceFrequencyTiers extends ApiResource<PriceFrequencyTier> {
  ...
  async create(
    resource: PriceFrequencyTierCreate,
    params?: QueryParamsRetrieve<PriceFrequencyTier>,
    options?: ResourcesConfig,
  ): Promise<PriceFrequencyTier> {
    return this.resources.create<PriceFrequencyTierCreate, PriceFrequencyTier>(
      { ...resource, type: PriceFrequencyTiers.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: PriceFrequencyTierUpdate,
    params?: QueryParamsRetrieve<PriceFrequencyTier>,
    options?: ResourcesConfig,
  ): Promise<PriceFrequencyTier> {
    return this.resources.update<PriceFrequencyTierUpdate, PriceFrequencyTier>(
      { ...resource, type: PriceFrequencyTiers.TYPE },
      params,
      options,
    )
  ...
  async price(
    priceFrequencyTierId: string | PriceFrequencyTier,
    ...
    return this.resources.fetch<Price>(
      { type: 'prices' },
      `price_frequency_tiers/${_priceFrequencyTierId}/price`,
      params,
      options,
    ) as unknown as Price
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `price_frequency_tiers/${_priceFrequencyTierId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `price_frequency_tiers/${_priceFrequencyTierId}/event_stores`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `price_frequency_tiers/${_priceFrequencyTierId}/events`,
      params,
      options,
