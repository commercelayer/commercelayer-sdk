...
import type { OrderReview } from './order_reviews'
...
interface Order extends Resource {
  ...
  guest?: boolean | null
  /**
   * Indicates if the order is on hold because the last order review is pending.
   */
  ...
  /**
   * A free-text note on the order. The latest value is kept.
   * @example ```"Please leave at the reception"```
   */
  notes?: string | null
  /**
  ...
  order_reviews?: OrderReview[] | null
...
class Orders extends ApiResource<Order> {
  ...
  async shipping_address(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `orders/${_orderId}/shipping_address`,
      params,
      options,
  ...
  async billing_address(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `orders/${_orderId}/billing_address`,
      params,
      options,
    ) as unknown as Address
  }
  ...
  async agreement(
    ...
    return this.resources.fetch<Agreement>(
      { type: 'agreements' },
      `orders/${_orderId}/agreement`,
      params,
      options,
    ) as unknown as Agreement
  }

  async inbound_message(
    orderId: string | Order,
    params?: QueryParamsRetrieve<InboundMessage>,
    options?: ResourcesConfig,
  ): Promise<InboundMessage> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<InboundMessage>(
      { type: 'inbound_messages' },
      `orders/${_orderId}/inbound_message`,
      params,
      options,
    ) as unknown as InboundMessage
  }

  async agent(orderId: string | Order, params?: QueryParamsRetrieve<Agent>, options?: ResourcesConfig): Promise<Agent> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Agent>(
      { type: 'agents' },
      `orders/${_orderId}/agent`,
      params,
      options,
    ) as unknown as Agent
  }
  ...
  async default_shipping_method(
    ...
    return this.resources.fetch<ShippingMethod>(
      ...
      `orders/${_orderId}/default_shipping_method`,
      params,
      options,
  ...
  async default_payment_method(
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `orders/${_orderId}/default_payment_method`,
      params,
      options,
  ...
  async available_payment_methods(
    ...
    return this.resources.fetch<PaymentMethod>(
      { type: 'payment_methods' },
      `orders/${_orderId}/available_payment_methods`,
      params,
      options,
  ...
  async available_customer_payment_sources(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<CustomerPaymentSource>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<CustomerPaymentSource>(
      { type: 'customer_payment_sources' },
      `orders/${_orderId}/available_customer_payment_sources`,
      params,
      options,
    ) as unknown as ListResponse<CustomerPaymentSource>
  }

  async available_free_skus(
    orderId: string | Order,
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `orders/${_orderId}/available_free_skus`,
      params,
      options,
    ) as unknown as ListResponse<Sku>
  }

  async available_free_bundles(
    orderId: string | Order,
    params?: QueryParamsList<Bundle>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Bundle>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Bundle>(
      { type: 'bundles' },
      `orders/${_orderId}/available_free_bundles`,
      params,
      options,
  ...
  async payment_method(
    ...
    return this.resources.fetch<PaymentMethod>(
      { type: 'payment_methods' },
      `orders/${_orderId}/payment_method`,
      params,
      options,
    ) as unknown as PaymentMethod
  }

  async discount_engine_item(
    orderId: string | Order,
    params?: QueryParamsRetrieve<DiscountEngineItem>,
    options?: ResourcesConfig,
  ): Promise<DiscountEngineItem> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<DiscountEngineItem>(
      { type: 'discount_engine_items' },
      `orders/${_orderId}/discount_engine_item`,
      params,
      options,
    ) as unknown as DiscountEngineItem
  }

  async line_items(
    orderId: string | Order,
    params?: QueryParamsList<LineItem>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<LineItem>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `orders/${_orderId}/line_items`,
      params,
      options,
    ) as unknown as ListResponse<LineItem>
  }

  async order_reviews(
    orderId: string | Order,
    params?: QueryParamsList<OrderReview>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<OrderReview>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<OrderReview>(
      { type: 'order_reviews' },
      `orders/${_orderId}/order_reviews`,
      params,
      options,
    ) as unknown as ListResponse<OrderReview>
  }

  async line_item_options(
    orderId: string | Order,
    params?: QueryParamsList<LineItemOption>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<LineItemOption>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<LineItemOption>(
      { type: 'line_item_options' },
      `orders/${_orderId}/line_item_options`,
      params,
      options,
  ...
  async stock_reservations(
    ...
    return this.resources.fetch<StockReservation>(
      ...
      `orders/${_orderId}/stock_reservations`,
      params,
      options,
  ...
  async stock_line_items(
    orderId: string | Order,
    params?: QueryParamsList<StockLineItem>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<StockLineItem>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<StockLineItem>(
      { type: 'stock_line_items' },
      `orders/${_orderId}/stock_line_items`,
      params,
      options,
    ) as unknown as ListResponse<StockLineItem>
  }

  async stock_transfers(
    orderId: string | Order,
    params?: QueryParamsList<StockTransfer>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<StockTransfer>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<StockTransfer>(
      { type: 'stock_transfers' },
      `orders/${_orderId}/stock_transfers`,
      params,
      options,
  ...
  async payment_options(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<PaymentOption>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<PaymentOption>(
      { type: 'payment_options' },
      `orders/${_orderId}/payment_options`,
      params,
      options,
  ...
  async authorizations(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<Authorization>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Authorization>(
      { type: 'authorizations' },
      `orders/${_orderId}/authorizations`,
      params,
      options,
  ...
  async captures(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<Capture>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Capture>(
      { type: 'captures' },
      `orders/${_orderId}/captures`,
      params,
      options,
  ...
  async voids(
    ...
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Void>(
      { type: 'voids' },
      `orders/${_orderId}/voids`,
      params,
      options,
  ...
  async refunds(
    ...
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Refund>(
      { type: 'refunds' },
      `orders/${_orderId}/refunds`,
      params,
      options,
  ...
  async returns(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<Return>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Return>(
      { type: 'returns' },
      `orders/${_orderId}/returns`,
      params,
      options,
    ) as unknown as ListResponse<Return>
  }
  ...
  async order_subscription(
    ...
    return this.resources.fetch<OrderSubscription>(
      ...
      `orders/${_orderId}/order_subscription`,
      params,
      options,
    ) as unknown as OrderSubscription
  }
  ...
  async order_subscriptions(
    ...
    return this.resources.fetch<OrderSubscription>(
      { type: 'order_subscriptions' },
      `orders/${_orderId}/order_subscriptions`,
      params,
      options,
    ) as unknown as ListResponse<OrderSubscription>
  }

  async order_factories(
    orderId: string | Order,
    params?: QueryParamsList<OrderFactory>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<OrderFactory>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<OrderFactory>(
      { type: 'order_factories' },
      `orders/${_orderId}/order_factories`,
      params,
      options,
  ...
  async recurring_order_copies(
    ...
    options?: ResourcesConfig,
  ): Promise<ListResponse<RecurringOrderCopy>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<RecurringOrderCopy>(
      { type: 'recurring_order_copies' },
      `orders/${_orderId}/recurring_order_copies`,
      params,
      options,
    ) as unknown as ListResponse<RecurringOrderCopy>
  }
  ...
  async notifications(
    orderId: string | Order,
    params?: QueryParamsList<Notification>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Notification>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Notification>(
      { type: 'notifications' },
      `orders/${_orderId}/notifications`,
      params,
      options,
    ) as unknown as ListResponse<Notification>
  }

  async links(
    orderId: string | Order,
    params?: QueryParamsList<Link>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Link>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Link>(
      { type: 'links' },
      `orders/${_orderId}/links`,
      params,
      options,
    ) as unknown as ListResponse<Link>
  }
  ...
  async resource_errors(
    ...
    return this.resources.fetch<ResourceError>(
      ...
      `orders/${_orderId}/resource_errors`,
      params,
      options,
  ...
  async tags(
    orderId: string | Order,
    params?: QueryParamsList<Tag>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<Tag>> {
    const _orderId = (orderId as Order).id || (orderId as string)
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `orders/${_orderId}/tags`,
      params,
      options,
    ) as unknown as ListResponse<Tag>
  }
  ...
  async _archive(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _archive: true },
      params,
      options,
    )
  }
  ...
  async _unarchive(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _unarchive: true },
      params,
      options,
    )
  }
  ...
  async _pending(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _pending: true },
      params,
      options,
    )
  }
  ...
  async _cancel(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _cancel: true },
      params,
      options,
    )
  }
  ...
  async _approve(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _approve: true },
      params,
      options,
    )
  }

  async _approve_and_capture(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _approve_and_capture: true },
      params,
      options,
    )
  }
  ...
  async _authorize(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _authorize: true },
      params,
      options,
    )
  }

  async _authorization_amount_cents(
    id: string | Order,
    triggerValue: number,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _authorization_amount_cents: triggerValue },
      params,
      options,
    )
  }
  ...
  async _capture(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _capture: true },
      params,
      options,
    )
  }
  ...
  async _refund(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _refund: true },
      params,
      options,
    )
  }
  ...
  async _fulfill(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _fulfill: true },
      params,
      options,
    )
  }
  ...
  async _update_taxes(
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _update_taxes: true },
      params,
      options,
    )
  }

  async _nullify_payment_source(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _nullify_payment_source: true },
      params,
      options,
    )
  }

  async _fix_payment_source(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _fix_payment_source: true },
      params,
      options,
    )
  }

  async _billing_address_clone_id(
    id: string | Order,
    triggerValue: string,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _billing_address_clone_id: triggerValue },
      params,
      options,
    )
  }

  async _shipping_address_clone_id(
    id: string | Order,
    triggerValue: string,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _shipping_address_clone_id: triggerValue },
      params,
      options,
    )
  }

  async _customer_payment_source_id(
    id: string | Order,
    triggerValue: string,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _customer_payment_source_id: triggerValue },
      params,
      options,
    )
  }

  async _shipping_address_same_as_billing(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _shipping_address_same_as_billing: true },
      params,
      options,
    )
  }

  async _billing_address_same_as_shipping(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _billing_address_same_as_shipping: true },
      params,
      options,
    )
  }

  async _commit_invoice(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _commit_invoice: true },
      params,
      options,
    )
  }

  async _refund_invoice(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _refund_invoice: true },
      params,
      options,
    )
  }

  async _save_payment_source_to_customer_wallet(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _save_payment_source_to_customer_wallet: true },
      params,
      options,
    )
  }

  async _save_shipping_address_to_customer_address_book(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
  ...
  async _save_billing_address_to_customer_address_book(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
  ...
  async _refresh(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _refresh: true },
      params,
      options,
    )
  }

  async _refresh_prices(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _refresh_prices: true },
      params,
      options,
    )
  }
  ...
  async _validate(id: string | Order, params?: QueryParamsRetrieve<Order>, options?: ResourcesConfig): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _validate: true },
      params,
      options,
    )
  }

  async _create_subscriptions(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _create_subscriptions: true },
      params,
      options,
    )
  }

  async _start_editing(
    id: string | Order,
    params?: QueryParamsRetrieve<Order>,
    options?: ResourcesConfig,
  ): Promise<Order> {
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _start_editing: true },
      params,
      options,
    )
  }
  ...
  async _stop_editing(
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _stop_editing: true },
      params,
      options,
    )
  }
  ...
  async _reset_circuit(
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _reset_circuit: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<OrderUpdate, Order>(
      { id: typeof id === 'string' ? id : id.id, type: Orders.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
...
export type { Order, OrderCreate, Orders, OrderType, OrderUpdate }
