...
// export type PaymentSettingAdyenFilter = Pick<PaymentSettingAdyen, 'id' | 'gateway_version' | 'internal_versionable' | 'auto_capture' | 'auto_place' | 'name' | 'disabled_at'> & ResourceFilter
...
interface PaymentSettingAdyen extends Resource {
  ...
  /**
   * The gateway tokenization webhook endpoint secret, generated by Adyen customer area.
   * @example ```"xxxx-yyyy-zzzz"```
   */
  token_webhook_endpoint_secret?: string | null
