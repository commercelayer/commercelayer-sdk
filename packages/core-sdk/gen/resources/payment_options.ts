...
class PaymentOptions extends ApiResource<PaymentOption> {
  ...
  async create(
    resource: PaymentOptionCreate,
    params?: QueryParamsRetrieve<PaymentOption>,
    options?: ResourcesConfig,
  ): Promise<PaymentOption> {
    return this.resources.create<PaymentOptionCreate, PaymentOption>(
      { ...resource, type: PaymentOptions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: PaymentOptionUpdate,
    params?: QueryParamsRetrieve<PaymentOption>,
    options?: ResourcesConfig,
  ): Promise<PaymentOption> {
    return this.resources.update<PaymentOptionUpdate, PaymentOption>(
      { ...resource, type: PaymentOptions.TYPE },
      params,
      options,
    )
  ...
  async order(
    paymentOptionId: string | PaymentOption,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `payment_options/${_paymentOptionId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `payment_options/${_paymentOptionId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `payment_options/${_paymentOptionId}/event_stores`,
      params,
      options,
