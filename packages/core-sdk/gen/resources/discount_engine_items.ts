...
class DiscountEngineItems extends ApiResource<DiscountEngineItem> {
  ...
  async discount_engine(
    discountEngineItemId: string | DiscountEngineItem,
    ...
    return this.resources.fetch<DiscountEngine>(
      ...
      `discount_engine_items/${_discountEngineItemId}/discount_engine`,
      params,
      options,
  ...
  async order(
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `discount_engine_items/${_discountEngineItemId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `discount_engine_items/${_discountEngineItemId}/event_stores`,
      params,
      options,
...
export type { DiscountEngineItem, DiscountEngineItems, DiscountEngineItemType }
