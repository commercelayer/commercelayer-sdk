...
export type FixedAmountPromotionSort = Pick<
...
/**
 * The Fixed amount promotion object is returned as part of the response body of each successful list, retrieve, create, update or delete API call to the /api/fixed_amount_promotions endpoint.
 *
 * @link https://docs.commercelayer.io/core-api-reference/fixed_amount_promotions/object
 */
...
class FixedAmountPromotions extends ApiResource<FixedAmountPromotion> {
  ...
  async create(
    resource: FixedAmountPromotionCreate,
    params?: QueryParamsRetrieve<FixedAmountPromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedAmountPromotion> {
    return this.resources.create<FixedAmountPromotionCreate, FixedAmountPromotion>(
      { ...resource, type: FixedAmountPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: FixedAmountPromotionUpdate,
    params?: QueryParamsRetrieve<FixedAmountPromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedAmountPromotion> {
    return this.resources.update<FixedAmountPromotionUpdate, FixedAmountPromotion>(
      { ...resource, type: FixedAmountPromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    fixedAmountPromotionId: string | FixedAmountPromotion,
    params?: QueryParamsRetrieve<Market>,
    options?: ResourcesConfig,
  ): Promise<Market> {
    const _fixedAmountPromotionId =
      (fixedAmountPromotionId as FixedAmountPromotion).id || (fixedAmountPromotionId as string)
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `fixed_amount_promotions/${_fixedAmountPromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `fixed_amount_promotions/${_fixedAmountPromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `fixed_amount_promotions/${_fixedAmountPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `fixed_amount_promotions/${_fixedAmountPromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/event_stores`,
      params,
      options,
  ...
  async skus(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `fixed_amount_promotions/${_fixedAmountPromotionId}/skus`,
      params,
      options,
  ...
  async _disable(
    id: string | FixedAmountPromotion,
    params?: QueryParamsRetrieve<FixedAmountPromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedAmountPromotion> {
    return this.resources.update<FixedAmountPromotionUpdate, FixedAmountPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedAmountPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<FixedAmountPromotionUpdate, FixedAmountPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedAmountPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<FixedAmountPromotionUpdate, FixedAmountPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedAmountPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<FixedAmountPromotionUpdate, FixedAmountPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedAmountPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
