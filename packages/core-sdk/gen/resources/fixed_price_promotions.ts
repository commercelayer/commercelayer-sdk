...
export type FixedPricePromotionSort = Pick<
  FixedPricePromotion,
  | 'id'
  | 'name'
  | 'currency_code'
...
class FixedPricePromotions extends ApiResource<FixedPricePromotion> {
  ...
  async create(
    resource: FixedPricePromotionCreate,
    params?: QueryParamsRetrieve<FixedPricePromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedPricePromotion> {
    return this.resources.create<FixedPricePromotionCreate, FixedPricePromotion>(
      { ...resource, type: FixedPricePromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: FixedPricePromotionUpdate,
    params?: QueryParamsRetrieve<FixedPricePromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedPricePromotion> {
    return this.resources.update<FixedPricePromotionUpdate, FixedPricePromotion>(
      { ...resource, type: FixedPricePromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    ...
    const _fixedPricePromotionId =
      (fixedPricePromotionId as FixedPricePromotion).id || (fixedPricePromotionId as string)
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `fixed_price_promotions/${_fixedPricePromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `fixed_price_promotions/${_fixedPricePromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `fixed_price_promotions/${_fixedPricePromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `fixed_price_promotions/${_fixedPricePromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `fixed_price_promotions/${_fixedPricePromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `fixed_price_promotions/${_fixedPricePromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `fixed_price_promotions/${_fixedPricePromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `fixed_price_promotions/${_fixedPricePromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `fixed_price_promotions/${_fixedPricePromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `fixed_price_promotions/${_fixedPricePromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `fixed_price_promotions/${_fixedPricePromotionId}/event_stores`,
      params,
      options,
  ...
  async skus(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `fixed_price_promotions/${_fixedPricePromotionId}/skus`,
      params,
      options,
  ...
  async _disable(
    id: string | FixedPricePromotion,
    params?: QueryParamsRetrieve<FixedPricePromotion>,
    options?: ResourcesConfig,
  ): Promise<FixedPricePromotion> {
    return this.resources.update<FixedPricePromotionUpdate, FixedPricePromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedPricePromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<FixedPricePromotionUpdate, FixedPricePromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedPricePromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<FixedPricePromotionUpdate, FixedPricePromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedPricePromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<FixedPricePromotionUpdate, FixedPricePromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FixedPricePromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
