...
class CustomerPasswordResets extends ApiResource<CustomerPasswordReset> {
  ...
  async create(
    resource: CustomerPasswordResetCreate,
    params?: QueryParamsRetrieve<CustomerPasswordReset>,
    options?: ResourcesConfig,
  ): Promise<CustomerPasswordReset> {
    return this.resources.create<CustomerPasswordResetCreate, CustomerPasswordReset>(
      { ...resource, type: CustomerPasswordResets.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: CustomerPasswordResetUpdate,
    params?: QueryParamsRetrieve<CustomerPasswordReset>,
    options?: ResourcesConfig,
  ): Promise<CustomerPasswordReset> {
    return this.resources.update<CustomerPasswordResetUpdate, CustomerPasswordReset>(
      { ...resource, type: CustomerPasswordResets.TYPE },
      params,
      options,
    )
  ...
  async customer(
    customerPasswordResetId: string | CustomerPasswordReset,
    params?: QueryParamsRetrieve<Customer>,
    options?: ResourcesConfig,
  ): Promise<Customer> {
    const _customerPasswordResetId =
      (customerPasswordResetId as CustomerPasswordReset).id || (customerPasswordResetId as string)
    return this.resources.fetch<Customer>(
      { type: 'customers' },
      `customer_password_resets/${_customerPasswordResetId}/customer`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `customer_password_resets/${_customerPasswordResetId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `customer_password_resets/${_customerPasswordResetId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async _reset_password_token(
    id: string | CustomerPasswordReset,
    triggerValue: string,
    params?: QueryParamsRetrieve<CustomerPasswordReset>,
    options?: ResourcesConfig,
  ): Promise<CustomerPasswordReset> {
