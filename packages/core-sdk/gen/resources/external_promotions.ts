...
class ExternalPromotions extends ApiResource<ExternalPromotion> {
  ...
  async create(
    resource: ExternalPromotionCreate,
    params?: QueryParamsRetrieve<ExternalPromotion>,
    options?: ResourcesConfig,
  ): Promise<ExternalPromotion> {
    return this.resources.create<ExternalPromotionCreate, ExternalPromotion>(
      { ...resource, type: ExternalPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { ...resource, type: ExternalPromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    externalPromotionId: string | ExternalPromotion,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `external_promotions/${_externalPromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `external_promotions/${_externalPromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `external_promotions/${_externalPromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `external_promotions/${_externalPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `external_promotions/${_externalPromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `external_promotions/${_externalPromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `external_promotions/${_externalPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `external_promotions/${_externalPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `external_promotions/${_externalPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `external_promotions/${_externalPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `external_promotions/${_externalPromotionId}/event_stores`,
      params,
      options,
  ...
  async skus(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `external_promotions/${_externalPromotionId}/skus`,
      params,
      options,
  ...
  async _disable(
    id: string | ExternalPromotion,
    params?: QueryParamsRetrieve<ExternalPromotion>,
    options?: ResourcesConfig,
  ): Promise<ExternalPromotion> {
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _reset_circuit(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _reset_circuit: true },
      params,
      options,
    )
  }
  ...
  async _regenerate_shared_secret(
    ...
    return this.resources.update<ExternalPromotionUpdate, ExternalPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalPromotions.TYPE, _regenerate_shared_secret: true },
      params,
      options,
    )
  }
