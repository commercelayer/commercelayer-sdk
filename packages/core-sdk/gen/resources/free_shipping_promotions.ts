...
export type FreeShippingPromotionSort = Pick<
...
class FreeShippingPromotions extends ApiResource<FreeShippingPromotion> {
  ...
  async create(
    resource: FreeShippingPromotionCreate,
    params?: QueryParamsRetrieve<FreeShippingPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeShippingPromotion> {
    return this.resources.create<FreeShippingPromotionCreate, FreeShippingPromotion>(
      { ...resource, type: FreeShippingPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: FreeShippingPromotionUpdate,
    params?: QueryParamsRetrieve<FreeShippingPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeShippingPromotion> {
    return this.resources.update<FreeShippingPromotionUpdate, FreeShippingPromotion>(
      { ...resource, type: FreeShippingPromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    ...
    const _freeShippingPromotionId =
      (freeShippingPromotionId as FreeShippingPromotion).id || (freeShippingPromotionId as string)
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `free_shipping_promotions/${_freeShippingPromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `free_shipping_promotions/${_freeShippingPromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `free_shipping_promotions/${_freeShippingPromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `free_shipping_promotions/${_freeShippingPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `free_shipping_promotions/${_freeShippingPromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `free_shipping_promotions/${_freeShippingPromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `free_shipping_promotions/${_freeShippingPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `free_shipping_promotions/${_freeShippingPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `free_shipping_promotions/${_freeShippingPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `free_shipping_promotions/${_freeShippingPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `free_shipping_promotions/${_freeShippingPromotionId}/event_stores`,
      params,
      options,
  ...
  async _disable(
    id: string | FreeShippingPromotion,
    params?: QueryParamsRetrieve<FreeShippingPromotion>,
    options?: ResourcesConfig,
  ): Promise<FreeShippingPromotion> {
    return this.resources.update<FreeShippingPromotionUpdate, FreeShippingPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeShippingPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<FreeShippingPromotionUpdate, FreeShippingPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeShippingPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<FreeShippingPromotionUpdate, FreeShippingPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeShippingPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<FreeShippingPromotionUpdate, FreeShippingPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: FreeShippingPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
