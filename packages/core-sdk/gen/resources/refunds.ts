...
class Refunds extends ApiResource<Refund> {
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `refunds/${_refundId}/event_stores`,
      params,
      options,
  ...
  async reference_capture(
    ...
    return this.resources.fetch<Capture>(
      { type: 'captures' },
      `refunds/${_refundId}/reference_capture`,
      params,
      options,
  ...
  async _forward(
    ...
    return this.resources.update<RefundUpdate, Refund>(
      { id: typeof id === 'string' ? id : id.id, type: Refunds.TYPE, _forward: true },
      params,
      options,
    )
  }
