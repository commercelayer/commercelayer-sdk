...
##__IMPORT_ACTION_PAYLOADS__##

type ##__MODEL_RESOURCE_INTERFACE__##Type = '##__RESOURCE_TYPE__##'##__STI_TYPE_UNION__##
...
export type { ##__RESOURCE_CLASS__##, ##__EXPORT_RESOURCE_TYPES__##, ##__MODEL_RESOURCE_INTERFACE__##Type }
