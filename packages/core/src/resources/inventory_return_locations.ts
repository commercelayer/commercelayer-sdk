...
class InventoryReturnLocations extends ApiResource<InventoryReturnLocation> {
  ...
  async create(
    resource: InventoryReturnLocationCreate,
    params?: QueryParamsRetrieve<InventoryReturnLocation>,
    options?: ResourcesConfig,
  ): Promise<InventoryReturnLocation> {
    return this.resources.create<InventoryReturnLocationCreate, InventoryReturnLocation>(
      { ...resource, type: InventoryReturnLocations.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: InventoryReturnLocationUpdate,
    params?: QueryParamsRetrieve<InventoryReturnLocation>,
    options?: ResourcesConfig,
  ): Promise<InventoryReturnLocation> {
    return this.resources.update<InventoryReturnLocationUpdate, InventoryReturnLocation>(
      { ...resource, type: InventoryReturnLocations.TYPE },
      params,
      options,
    )
  ...
  async stock_location(
    ...
    const _inventoryReturnLocationId =
      (inventoryReturnLocationId as InventoryReturnLocation).id || (inventoryReturnLocationId as string)
    return this.resources.fetch<StockLocation>(
      { type: 'stock_locations' },
      `inventory_return_locations/${_inventoryReturnLocationId}/stock_location`,
      params,
      options,
  ...
  async inventory_model(
    ...
    return this.resources.fetch<InventoryModel>(
      ...
      `inventory_return_locations/${_inventoryReturnLocationId}/inventory_model`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `inventory_return_locations/${_inventoryReturnLocationId}/event_stores`,
      params,
      options,
