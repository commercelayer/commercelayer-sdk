...
class CarrierAccounts extends ApiResource<CarrierAccount> {
  ...
  async create(
    resource: CarrierAccountCreate,
    params?: QueryParamsRetrieve<CarrierAccount>,
    options?: ResourcesConfig,
  ): Promise<CarrierAccount> {
    return this.resources.create<CarrierAccountCreate, CarrierAccount>(
      { ...resource, type: CarrierAccounts.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: CarrierAccountUpdate,
    params?: QueryParamsRetrieve<CarrierAccount>,
    options?: ResourcesConfig,
  ): Promise<CarrierAccount> {
    return this.resources.update<CarrierAccountUpdate, CarrierAccount>(
      { ...resource, type: CarrierAccounts.TYPE },
      params,
      options,
    )
  ...
  async market(
    carrierAccountId: string | CarrierAccount,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `carrier_accounts/${_carrierAccountId}/market`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `carrier_accounts/${_carrierAccountId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `carrier_accounts/${_carrierAccountId}/event_stores`,
      params,
      options,
