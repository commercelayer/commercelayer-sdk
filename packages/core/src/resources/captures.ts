...
class Captures extends ApiResource<Capture> {
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `captures/${_captureId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `captures/${_captureId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async reference_authorization(
    captureId: string | Capture,
    ...
    return this.resources.fetch<Authorization>(
      { type: 'authorizations' },
      `captures/${_captureId}/reference_authorization`,
      params,
      options,
  ...
  async _forward(
    ...
    return this.resources.update<CaptureUpdate, Capture>(
      { id: typeof id === 'string' ? id : id.id, type: Captures.TYPE, _forward: true },
      params,
      options,
    )
  }
  ...
  async _refund(
    ...
    return this.resources.update<CaptureUpdate, Capture>(
      { id: typeof id === 'string' ? id : id.id, type: Captures.TYPE, _refund: true },
      params,
      options,
    )
  }
  ...
  async _refund_amount_cents(
    ...
    return this.resources.update<CaptureUpdate, Capture>(
      { id: typeof id === 'string' ? id : id.id, type: Captures.TYPE, _refund_amount_cents: triggerValue },
      params,
      options,
    )
  }
  ...
  async _cancel(
    ...
    return this.resources.update<CaptureUpdate, Capture>(
      { id: typeof id === 'string' ? id : id.id, type: Captures.TYPE, _cancel: true },
      params,
      options,
    )
  }
