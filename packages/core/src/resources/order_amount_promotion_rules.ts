...
class OrderAmountPromotionRules extends ApiResource<OrderAmountPromotionRule> {
  ...
  async create(
    resource: OrderAmountPromotionRuleCreate,
    params?: QueryParamsRetrieve<OrderAmountPromotionRule>,
    options?: ResourcesConfig,
  ): Promise<OrderAmountPromotionRule> {
    return this.resources.create<OrderAmountPromotionRuleCreate, OrderAmountPromotionRule>(
      { ...resource, type: OrderAmountPromotionRules.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: OrderAmountPromotionRuleUpdate,
    params?: QueryParamsRetrieve<OrderAmountPromotionRule>,
    options?: ResourcesConfig,
  ): Promise<OrderAmountPromotionRule> {
    return this.resources.update<OrderAmountPromotionRuleUpdate, OrderAmountPromotionRule>(
      { ...resource, type: OrderAmountPromotionRules.TYPE },
      params,
      options,
    )
  ...
  async event_stores(
    orderAmountPromotionRuleId: string | OrderAmountPromotionRule,
    params?: QueryParamsList<EventStore>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<EventStore>> {
    const _orderAmountPromotionRuleId =
      (orderAmountPromotionRuleId as OrderAmountPromotionRule).id || (orderAmountPromotionRuleId as string)
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `order_amount_promotion_rules/${_orderAmountPromotionRuleId}/event_stores`,
      params,
      options,
