...
class Authorizations extends ApiResource<Authorization> {
  ...
  async update(
    resource: AuthorizationUpdate,
    params?: QueryParamsRetrieve<Authorization>,
    options?: ResourcesConfig,
  ): Promise<Authorization> {
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { ...resource, type: Authorizations.TYPE },
      params,
      options,
    )
  }
  ...
  async order(
    authorizationId: string | Authorization,
    ...
    return this.resources.fetch<Order>(
      { type: 'orders' },
      `authorizations/${_authorizationId}/order`,
      params,
      options,
    ) as unknown as Order
  }
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `authorizations/${_authorizationId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `authorizations/${_authorizationId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `authorizations/${_authorizationId}/event_stores`,
      params,
      options,
  ...
  async captures(
    ...
    return this.resources.fetch<Capture>(
      { type: 'captures' },
      `authorizations/${_authorizationId}/captures`,
      params,
      options,
  ...
  async voids(
    ...
    return this.resources.fetch<Void>(
      { type: 'voids' },
      `authorizations/${_authorizationId}/voids`,
      params,
      options,
  ...
  async _forward(
    id: string | Authorization,
    params?: QueryParamsRetrieve<Authorization>,
    options?: ResourcesConfig,
  ): Promise<Authorization> {
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { id: typeof id === 'string' ? id : id.id, type: Authorizations.TYPE, _forward: true },
      params,
      options,
    )
  }
  ...
  async _capture(
    ...
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { id: typeof id === 'string' ? id : id.id, type: Authorizations.TYPE, _capture: true },
      params,
      options,
    )
  }

  async _capture_amount_cents(
    id: string | Authorization,
    triggerValue: number,
    params?: QueryParamsRetrieve<Authorization>,
    options?: ResourcesConfig,
    ...
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { id: typeof id === 'string' ? id : id.id, type: Authorizations.TYPE, _capture_amount_cents: triggerValue },
      params,
      options,
    )
  }
  ...
  async _void(
    ...
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { id: typeof id === 'string' ? id : id.id, type: Authorizations.TYPE, _void: true },
      params,
      options,
    )
  }
  ...
  async _cancel(
    ...
    return this.resources.update<AuthorizationUpdate, Authorization>(
      { id: typeof id === 'string' ? id : id.id, type: Authorizations.TYPE, _cancel: true },
      params,
      options,
    )
  }
...
export type { Authorization, Authorizations, AuthorizationType, AuthorizationUpdate }
