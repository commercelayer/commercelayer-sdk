...
class BuyXPayYPromotions extends ApiResource<BuyXPayYPromotion> {
  ...
  async create(
    resource: BuyXPayYPromotionCreate,
    params?: QueryParamsRetrieve<BuyXPayYPromotion>,
    options?: ResourcesConfig,
  ): Promise<BuyXPayYPromotion> {
    return this.resources.create<BuyXPayYPromotionCreate, BuyXPayYPromotion>(
      { ...resource, type: BuyXPayYPromotions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: BuyXPayYPromotionUpdate,
    params?: QueryParamsRetrieve<BuyXPayYPromotion>,
    options?: ResourcesConfig,
  ): Promise<BuyXPayYPromotion> {
    return this.resources.update<BuyXPayYPromotionUpdate, BuyXPayYPromotion>(
      { ...resource, type: BuyXPayYPromotions.TYPE },
      params,
      options,
    )
  ...
  async market(
    buyXPayYPromotionId: string | BuyXPayYPromotion,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/market`,
      params,
      options,
  ...
  async order_amount_promotion_rule(
    ...
    return this.resources.fetch<OrderAmountPromotionRule>(
      ...
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/order_amount_promotion_rule`,
      params,
      options,
  ...
  async sku_list_promotion_rule(
    ...
    return this.resources.fetch<SkuListPromotionRule>(
      ...
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/sku_list_promotion_rule`,
      params,
      options,
  ...
  async coupon_codes_promotion_rule(
    ...
    return this.resources.fetch<CouponCodesPromotionRule>(
      ...
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/coupon_codes_promotion_rule`,
      params,
      options,
  ...
  async custom_promotion_rule(
    ...
    return this.resources.fetch<CustomPromotionRule>(
      ...
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/custom_promotion_rule`,
      params,
      options,
  ...
  async sku_list(
    ...
    return this.resources.fetch<SkuList>(
      { type: 'sku_lists' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/sku_list`,
      params,
      options,
  ...
  async coupons(
    ...
    return this.resources.fetch<Coupon>(
      { type: 'coupons' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/coupons`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/event_stores`,
      params,
      options,
  ...
  async skus(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `buy_x_pay_y_promotions/${_buyXPayYPromotionId}/skus`,
      params,
      options,
  ...
  async _disable(
    id: string | BuyXPayYPromotion,
    params?: QueryParamsRetrieve<BuyXPayYPromotion>,
    options?: ResourcesConfig,
  ): Promise<BuyXPayYPromotion> {
    return this.resources.update<BuyXPayYPromotionUpdate, BuyXPayYPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: BuyXPayYPromotions.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<BuyXPayYPromotionUpdate, BuyXPayYPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: BuyXPayYPromotions.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _add_tags(
    ...
    return this.resources.update<BuyXPayYPromotionUpdate, BuyXPayYPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: BuyXPayYPromotions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<BuyXPayYPromotionUpdate, BuyXPayYPromotion>(
      { id: typeof id === 'string' ? id : id.id, type: BuyXPayYPromotions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
