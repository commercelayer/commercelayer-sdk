...
class StripeTaxAccounts extends ApiResource<StripeTaxAccount> {
  ...
  async create(
    resource: StripeTaxAccountCreate,
    params?: QueryParamsRetrieve<StripeTaxAccount>,
    options?: ResourcesConfig,
  ): Promise<StripeTaxAccount> {
    return this.resources.create<StripeTaxAccountCreate, StripeTaxAccount>(
      { ...resource, type: StripeTaxAccounts.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: StripeTaxAccountUpdate,
    params?: QueryParamsRetrieve<StripeTaxAccount>,
    options?: ResourcesConfig,
  ): Promise<StripeTaxAccount> {
    return this.resources.update<StripeTaxAccountUpdate, StripeTaxAccount>(
      { ...resource, type: StripeTaxAccounts.TYPE },
      params,
      options,
    )
  ...
  async markets(
    stripeTaxAccountId: string | StripeTaxAccount,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `stripe_tax_accounts/${_stripeTaxAccountId}/markets`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `stripe_tax_accounts/${_stripeTaxAccountId}/attachments`,
      params,
      options,
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `stripe_tax_accounts/${_stripeTaxAccountId}/events`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stripe_tax_accounts/${_stripeTaxAccountId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async tax_categories(
    stripeTaxAccountId: string | StripeTaxAccount,
    params?: QueryParamsList<TaxCategory>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<TaxCategory>> {
    const _stripeTaxAccountId = (stripeTaxAccountId as StripeTaxAccount).id || (stripeTaxAccountId as string)
    return this.resources.fetch<TaxCategory>(
      { type: 'tax_categories' },
      `stripe_tax_accounts/${_stripeTaxAccountId}/tax_categories`,
      params,
      options,
    ) as unknown as ListResponse<TaxCategory>
  }
