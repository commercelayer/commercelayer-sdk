...
export type ExternalGatewaySort = Pick<
  ExternalGateway,
...
class ExternalGateways extends ApiResource<ExternalGateway> {
  ...
  async create(
    resource: ExternalGatewayCreate,
    params?: QueryParamsRetrieve<ExternalGateway>,
    options?: ResourcesConfig,
  ): Promise<ExternalGateway> {
    return this.resources.create<ExternalGatewayCreate, ExternalGateway>(
      { ...resource, type: ExternalGateways.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: ExternalGatewayUpdate,
    params?: QueryParamsRetrieve<ExternalGateway>,
    options?: ResourcesConfig,
  ): Promise<ExternalGateway> {
    return this.resources.update<ExternalGatewayUpdate, ExternalGateway>(
      { ...resource, type: ExternalGateways.TYPE },
      params,
      options,
    )
  ...
  async payment_methods(
    externalGatewayId: string | ExternalGateway,
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `external_gateways/${_externalGatewayId}/payment_methods`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `external_gateways/${_externalGatewayId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async external_payments(
    externalGatewayId: string | ExternalGateway,
    params?: QueryParamsList<ExternalPayment>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<ExternalPayment>> {
    const _externalGatewayId = (externalGatewayId as ExternalGateway).id || (externalGatewayId as string)
    return this.resources.fetch<ExternalPayment>(
      { type: 'external_payments' },
      `external_gateways/${_externalGatewayId}/external_payments`,
      params,
      options,
    ) as unknown as ListResponse<ExternalPayment>
  }

  async _disable(
    id: string | ExternalGateway,
    params?: QueryParamsRetrieve<ExternalGateway>,
    options?: ResourcesConfig,
  ): Promise<ExternalGateway> {
    return this.resources.update<ExternalGatewayUpdate, ExternalGateway>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalGateways.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<ExternalGatewayUpdate, ExternalGateway>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalGateways.TYPE, _enable: true },
      params,
      options,
    )
  }
  ...
  async _reset_circuit(
    ...
    return this.resources.update<ExternalGatewayUpdate, ExternalGateway>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalGateways.TYPE, _reset_circuit: true },
      params,
      options,
    )
  }
  ...
  async _regenerate_shared_secret(
    ...
    return this.resources.update<ExternalGatewayUpdate, ExternalGateway>(
      { id: typeof id === 'string' ? id : id.id, type: ExternalGateways.TYPE, _regenerate_shared_secret: true },
      params,
      options,
    )
  }
