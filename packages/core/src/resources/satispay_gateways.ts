...
class SatispayGateways extends ApiResource<SatispayGateway> {
  ...
  async create(
    resource: SatispayGatewayCreate,
    params?: QueryParamsRetrieve<SatispayGateway>,
    options?: ResourcesConfig,
  ): Promise<SatispayGateway> {
    return this.resources.create<SatispayGatewayCreate, SatispayGateway>(
      { ...resource, type: SatispayGateways.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: SatispayGatewayUpdate,
    params?: QueryParamsRetrieve<SatispayGateway>,
    options?: ResourcesConfig,
  ): Promise<SatispayGateway> {
    return this.resources.update<SatispayGatewayUpdate, SatispayGateway>(
      { ...resource, type: SatispayGateways.TYPE },
      params,
      options,
    )
  ...
  async payment_methods(
    satispayGatewayId: string | SatispayGateway,
    ...
    return this.resources.fetch<PaymentMethod>(
      ...
      `satispay_gateways/${_satispayGatewayId}/payment_methods`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `satispay_gateways/${_satispayGatewayId}/event_stores`,
      params,
      options,
    ) as unknown as ListResponse<EventStore>
  }

  async satispay_payments(
    satispayGatewayId: string | SatispayGateway,
    params?: QueryParamsList<SatispayPayment>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<SatispayPayment>> {
    const _satispayGatewayId = (satispayGatewayId as SatispayGateway).id || (satispayGatewayId as string)
    return this.resources.fetch<SatispayPayment>(
      { type: 'satispay_payments' },
      `satispay_gateways/${_satispayGatewayId}/satispay_payments`,
      params,
      options,
    ) as unknown as ListResponse<SatispayPayment>
  }

  async _disable(
    id: string | SatispayGateway,
    params?: QueryParamsRetrieve<SatispayGateway>,
    options?: ResourcesConfig,
  ): Promise<SatispayGateway> {
    return this.resources.update<SatispayGatewayUpdate, SatispayGateway>(
      { id: typeof id === 'string' ? id : id.id, type: SatispayGateways.TYPE, _disable: true },
      params,
      options,
    )
  }
  ...
  async _enable(
    ...
    return this.resources.update<SatispayGatewayUpdate, SatispayGateway>(
      { id: typeof id === 'string' ? id : id.id, type: SatispayGateways.TYPE, _enable: true },
      params,
      options,
    )
  }
