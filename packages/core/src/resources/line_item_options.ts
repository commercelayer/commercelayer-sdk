...
export type LineItemOptionSort = Pick<
  LineItemOption,
  'id' | 'name' | 'quantity' | 'currency_code' | 'unit_amount_cents' | 'delay_hours'
> &
  ResourceSort
...
class LineItemOptions extends ApiResource<LineItemOption> {
  ...
  async create(
    resource: LineItemOptionCreate,
    params?: QueryParamsRetrieve<LineItemOption>,
    options?: ResourcesConfig,
  ): Promise<LineItemOption> {
    return this.resources.create<LineItemOptionCreate, LineItemOption>(
      { ...resource, type: LineItemOptions.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: LineItemOptionUpdate,
    params?: QueryParamsRetrieve<LineItemOption>,
    options?: ResourcesConfig,
  ): Promise<LineItemOption> {
    return this.resources.update<LineItemOptionUpdate, LineItemOption>(
      { ...resource, type: LineItemOptions.TYPE },
      params,
      options,
    )
  ...
  async line_item(
    lineItemOptionId: string | LineItemOption,
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `line_item_options/${_lineItemOptionId}/line_item`,
      params,
      options,
  ...
  async sku_option(
    lineItemOptionId: string | LineItemOption,
    params?: QueryParamsRetrieve<SkuOption>,
    options?: ResourcesConfig,
  ): Promise<SkuOption> {
    const _lineItemOptionId = (lineItemOptionId as LineItemOption).id || (lineItemOptionId as string)
    return this.resources.fetch<SkuOption>(
      { type: 'sku_options' },
      `line_item_options/${_lineItemOptionId}/sku_option`,
      params,
      options,
    ) as unknown as SkuOption
  }
  ...
  async events(
    ...
    return this.resources.fetch<Event>(
      { type: 'events' },
      `line_item_options/${_lineItemOptionId}/events`,
      params,
      options,
  ...
  async tags(
    ...
    return this.resources.fetch<Tag>(
      { type: 'tags' },
      `line_item_options/${_lineItemOptionId}/tags`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `line_item_options/${_lineItemOptionId}/event_stores`,
      params,
      options,
  ...
  async _add_tags(
    id: string | LineItemOption,
    triggerValue: string,
    params?: QueryParamsRetrieve<LineItemOption>,
    options?: ResourcesConfig,
  ): Promise<LineItemOption> {
    return this.resources.update<LineItemOptionUpdate, LineItemOption>(
      { id: typeof id === 'string' ? id : id.id, type: LineItemOptions.TYPE, _add_tags: triggerValue },
      params,
      options,
    )
  }
  ...
  async _remove_tags(
    ...
    return this.resources.update<LineItemOptionUpdate, LineItemOption>(
      { id: typeof id === 'string' ? id : id.id, type: LineItemOptions.TYPE, _remove_tags: triggerValue },
      params,
      options,
    )
  }
