...
class StockLineItems extends ApiResource<StockLineItem> {
  ...
  async create(
    resource: StockLineItemCreate,
    params?: QueryParamsRetrieve<StockLineItem>,
    options?: ResourcesConfig,
  ): Promise<StockLineItem> {
    return this.resources.create<StockLineItemCreate, StockLineItem>(
      { ...resource, type: StockLineItems.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: StockLineItemUpdate,
    params?: QueryParamsRetrieve<StockLineItem>,
    options?: ResourcesConfig,
  ): Promise<StockLineItem> {
    return this.resources.update<StockLineItemUpdate, StockLineItem>(
      { ...resource, type: StockLineItems.TYPE },
      params,
      options,
    )
  ...
  async shipment(
    stockLineItemId: string | StockLineItem,
    ...
    return this.resources.fetch<Shipment>(
      { type: 'shipments' },
      `stock_line_items/${_stockLineItemId}/shipment`,
      params,
      options,
  ...
  async line_item(
    ...
    return this.resources.fetch<LineItem>(
      { type: 'line_items' },
      `stock_line_items/${_stockLineItemId}/line_item`,
      params,
      options,
  ...
  async stock_item(
    ...
    return this.resources.fetch<StockItem>(
      { type: 'stock_items' },
      `stock_line_items/${_stockLineItemId}/stock_item`,
      params,
      options,
  ...
  async sku(
    ...
    return this.resources.fetch<Sku>(
      { type: 'skus' },
      `stock_line_items/${_stockLineItemId}/sku`,
      params,
      options,
    ) as unknown as Sku
  }
  ...
  async stock_reservation(
    ...
    return this.resources.fetch<StockReservation>(
      ...
      `stock_line_items/${_stockLineItemId}/stock_reservation`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `stock_line_items/${_stockLineItemId}/event_stores`,
      params,
      options,
  ...
  async _reserve_stock(
    id: string | StockLineItem,
    params?: QueryParamsRetrieve<StockLineItem>,
    options?: ResourcesConfig,
  ): Promise<StockLineItem> {
    return this.resources.update<StockLineItemUpdate, StockLineItem>(
      { id: typeof id === 'string' ? id : id.id, type: StockLineItems.TYPE, _reserve_stock: true },
      params,
      options,
    )
  }
  ...
  async _release_stock(
    ...
    return this.resources.update<StockLineItemUpdate, StockLineItem>(
      { id: typeof id === 'string' ? id : id.id, type: StockLineItems.TYPE, _release_stock: true },
      params,
      options,
    )
  }
  ...
  async _decrement_stock(
    ...
    return this.resources.update<StockLineItemUpdate, StockLineItem>(
      { id: typeof id === 'string' ? id : id.id, type: StockLineItems.TYPE, _decrement_stock: true },
      params,
      options,
    )
  }
...
export type { StockLineItem, StockLineItemCreate, StockLineItems, StockLineItemType, StockLineItemUpdate }
