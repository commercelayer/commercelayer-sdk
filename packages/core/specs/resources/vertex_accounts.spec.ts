...
import { type CommerceLayerSingleClient, type VertexAccount, vertex_accounts } from '../../src/single-client'
...
describe('VertexAccounts resource', () => {
  ...
  */
  ...
  test(resourceType + '._refresh_token', async () => {
    ...
    await vertex_accounts
      ._refresh_token(id, {}, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
