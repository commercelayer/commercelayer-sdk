...
import { type CommerceLayerSingleClient, type PromotionRule, promotion_rules } from '../../src/single-client'
...
describe('PromotionRules resource', () => {
  ...
  test(resourceType + '.type', async () => {
    const resource = { id: TestData.id, type: 'coupon_codes_promotion_rules' }
