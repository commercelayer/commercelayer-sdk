...
import { type CommerceLayerSingleClient, type Parcel, packages, parcels, shipments } from '../../src/single-client'
...
describe('Parcels resource', () => {
  ...
  */
  ...
  test(resourceType + '.package', async () => {
    ...
    await parcels
      .package(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
  ...
  test(resourceType + '.parcel_line_items', async () => {
    ...
    await parcels
      .parcel_line_items(id, params, CommonData.options)
      .catch(handleError)
      .finally(() => cl.removeInterceptor('request'))
  })
