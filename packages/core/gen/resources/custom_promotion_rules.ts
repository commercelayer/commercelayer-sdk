...
class CustomPromotionRules extends ApiResource<CustomPromotionRule> {
  ...
  async create(
    resource: CustomPromotionRuleCreate,
    params?: QueryParamsRetrieve<CustomPromotionRule>,
    options?: ResourcesConfig,
  ): Promise<CustomPromotionRule> {
    return this.resources.create<CustomPromotionRuleCreate, CustomPromotionRule>(
      { ...resource, type: CustomPromotionRules.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: CustomPromotionRuleUpdate,
    params?: QueryParamsRetrieve<CustomPromotionRule>,
    options?: ResourcesConfig,
  ): Promise<CustomPromotionRule> {
    return this.resources.update<CustomPromotionRuleUpdate, CustomPromotionRule>(
      { ...resource, type: CustomPromotionRules.TYPE },
      params,
      options,
    )
  ...
  async event_stores(
    customPromotionRuleId: string | CustomPromotionRule,
    params?: QueryParamsList<EventStore>,
    options?: ResourcesConfig,
  ): Promise<ListResponse<EventStore>> {
    const _customPromotionRuleId =
      (customPromotionRuleId as CustomPromotionRule).id || (customPromotionRuleId as string)
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `custom_promotion_rules/${_customPromotionRuleId}/event_stores`,
      params,
      options,
