...
class GoogleGeocoders extends ApiResource<GoogleGeocoder> {
  ...
  async create(
    resource: GoogleGeocoderCreate,
    params?: QueryParamsRetrieve<GoogleGeocoder>,
    options?: ResourcesConfig,
  ): Promise<GoogleGeocoder> {
    return this.resources.create<GoogleGeocoderCreate, GoogleGeocoder>(
      { ...resource, type: GoogleGeocoders.TYPE },
      params,
      options,
    )
  }
  ...
  async update(
    resource: GoogleGeocoderUpdate,
    params?: QueryParamsRetrieve<GoogleGeocoder>,
    options?: ResourcesConfig,
  ): Promise<GoogleGeocoder> {
    return this.resources.update<GoogleGeocoderUpdate, GoogleGeocoder>(
      { ...resource, type: GoogleGeocoders.TYPE },
      params,
      options,
    )
  ...
  async markets(
    googleGeocoderId: string | GoogleGeocoder,
    ...
    return this.resources.fetch<Market>(
      { type: 'markets' },
      `google_geocoders/${_googleGeocoderId}/markets`,
      params,
      options,
  ...
  async addresses(
    ...
    return this.resources.fetch<Address>(
      { type: 'addresses' },
      `google_geocoders/${_googleGeocoderId}/addresses`,
      params,
      options,
  ...
  async attachments(
    ...
    return this.resources.fetch<Attachment>(
      { type: 'attachments' },
      `google_geocoders/${_googleGeocoderId}/attachments`,
      params,
      options,
  ...
  async event_stores(
    ...
    return this.resources.fetch<EventStore>(
      { type: 'event_stores' },
      `google_geocoders/${_googleGeocoderId}/event_stores`,
      params,
      options,
